// ============================================================
// Astro Simulator — multi-exam study center
// Core Application Logic
//
// Questions are auto-generated from the saved snapshots in datasets/.
// To refresh them, drop new snapshot .html files into datasets/ and run:
//   python3 tools/parse_datasets.py
// ============================================================

"use strict";

// ---------- Category Constants (labels for the built-in PLAT-ADMN-301 exam) ----------
const CATEGORIES = {
...
// ---------- Study Center: exam registry ----------
// Each entry is a question bank + metadata. The list can be replaced at runtime
// by an exams.json manifest (fetched on startup); this embedded copy is the
// fallback and defines the built-in PLAT-ADMN-301 exam. Add an exam by dropping
// its bank JSON next to index.html and adding an entry here (or in exams.json).
...
const EXAM_REGISTRY = [
  {
    ...
    code: "PLAT-ADMN-301",
    subtitle: "Salesforce Certified · PLAT-ADMN-301 · Practice Questions",
    passingScore: 65,
    examMinutes: 105,
    bank: "questions.json",
    count: 220,
...
let examRegistry = EXAM_REGISTRY.slice();
let exam = EXAM_REGISTRY[0];
let CATEGORY_LIST = exam.categories.slice();

// >>> QUESTIONS START (auto-generated by tools/parse_datasets.py — do not edit by hand)
let QUESTIONS = [
  {
    id:1, category: CATEGORIES.AUTOMATION,
    text:"The director of sales wants to make sure that every opportunity has either a sales engineer or an account executive assigned to the deal. How should the administrator meet this requirement?",
    options:[
      {letter:"A", text:"Write a validation rule that checks if the fields are blank and require that one of them is completed in order to save the opportunity."},
      {letter:"B", text:"Create a different record type for deals with Sales Engineers and deals with Account Executives to capture one or the other."},
      {letter:"C", text:"Require the Sales Engineer and the Account Executive lookup fields on the page layout."},
  ...
  },
  {
    ...
    text:"AW Computing is running a special bundle deal on monitors and keyboards. Normally, discounts need VP approval, but this special bundle is pre-approved. What should the administrator recommend for these requirements?",
    options:[
      {letter:"A", text:"Create a separate price book."},
      {letter:"B", text:"Implement CPQ."},
      {letter:"C", text:"Remove the approval process."},
  ...
  },
  {
    ...
    options:[
      {letter:"A", text:"Build a Lightning component to display fields that only apply to condos."},
      {letter:"B", text:"Create a Record Type for the type of property and custom page layouts for each."},
      {letter:"C", text:"Configure a validation rule to display fields based on the type of property the user is viewing."},
  ...
  },
  {
    ...
    text:"At Ursa Major Solar, there is a custom object called Galaxy. The sales director wants users to only see certain fields. What Lightning component will satisfy this requirement?",
    options:[
      {letter:"A", text:"Record Detail Component"},
      {letter:"B", text:"Fields component"},
      {letter:"C", text:"Highlights Panel Component"},
  ...
  },
  {
    ...
    text:"An administrator has been asked to enable permissions for users on the account services team to be able to edit and change ownership of Accounts owned by any of the team members. What should the administrator configure?",
    options:[
      {letter:"A", text:"Set organization-wide sharing for Account as Public Read Only."},
      {letter:"B", text:"Create a Sharing Rule on the Account object for all members of the account services role to have Read/Write access."},
      {letter:"C", text:"Update the profile Account object to Modify All."},
  ...
  },
  {
    ...
    text:"AW Computing has a private sharing model for its accounts, but a sales rep occasionally needs assistance from an engineer. What feature should be used to grant the engineer access to the necessary account, while maintaining the company's data security?",
    options:[
      {letter:"A", text:"Permission Set"},
      {letter:"B", text:"Permission Set Group"},
      {letter:"C", text:"Account Teams"},
  ...
  },
  {
    ...
    text:"Ursa Major Solar allows its scientists to log new stars as they find them, but on occasion, they log the same star by mistake. The administrator wants scientists to be notified when a record is deleted and by whom, and to maintain their own discovery information. What automation solution should be used to send the notification?",
    options:[
      {letter:"A", text:"Heroku"},
      {letter:"B", text:"Process Builder"},
      {letter:"C", text:"Workflow Action"},
      {letter:"D", text:"flow"}
    ],
  ...
  },
  {
    ...
    text:"The administrator at Cloud Kicks has been requested to provide access to the Leads object to a contractor. The contractor currently has a profile that has access to a project management app within Salesforce. The contractor should only have View access to all of the Lead records. How should the administrator handle this request?",
    options:[
      {letter:"A", text:"Assign a permission set that has View All on Leads."},
      {letter:"B", text:"Add an app with the Leads tab to the user's profile."},
      {letter:"C", text:"Assign the contractor a public group with Lead access."},
  ...
  },
  {
    ...
    text:"Northern Trail Outfitters (NTO) is expanding into the U.K. While most of NTO’s products are the same as in the US. Pricing will vary by product due to shipping and raw material cost differences. What should the administrator configure for a smooth rollout to the U.K.?",
    options:[
      {letter:"A", text:"Configure a U.K Opportunity record type."},
      {letter:"B", text:"Write a flow that translates the currency from dollars to euros using a custom Exchange Rate field."},
  ...
  },
  {
    ...
    text:"AW Computing wants to create a process to assign accounts to different salespeople based on the annual revenue of the company. The administrator has decided to create a flow. Which two considerations should the administrator make sure to remember when creating the flow?",
    options:[
      {letter:"A", text:"Use a Get Record component instead of hard coding record IDs."},
      {letter:"B", text:"The running user of a flow is the user that last saved the flow."},
      {letter:"C", text:"Update record elements should be placed outside the flow loop."},
  ...
  },
  {
    ...
    text:"An administrator is planning the release process for the year. The team will be using change sets to process deployment to production. Which three best practices should be considered?",
    options:[
      {letter:"A", text:"Plan your deployments around the production and sandbox maintenance schedules."},
      {letter:"B", text:"Use matching names for global publisher layouts and Outlook publisher layouts."},
      {letter:"C", text:"Be sure to test the data after deployment."},
      {letter:"D", text:"Make sure to deploy all dependent components."},
  ...
  },
  {
    ...
    options:[
      {letter:"A", text:"Only standard objects can be used with Roll-up Summary fields."},
      {letter:"B", text:"Flows can only be triggered from the records created on standard objects."},
      {letter:"C", text:"Roll-up Summary calculations will prevent a flow from being triggered."},
  ...
  },
  {
    ...
    text:"A developer is getting errors for Production deployment. The test deployment in the Full sandbox, which included a local test run, was successful. The Full sandbox was last refreshed 2 weeks ago. Where should the administrator check to see what was recently changed?",
    options:[
      {letter:"A", text:"Salesforce Optimizer"},
      {letter:"B", text:"Dev Console"},
      {letter:"C", text:"Field History"},
  ...
  },
  {
    ...
    text:"The administrator at Cloud Kicks built a flow in a sandbox. After testing and validating the flow, the administrator plans to promote the flow to the production environment with a change set. Which three considerations should the administrator be aware of when moving flows with a change set? Choose 3 answers",
    options:[
      {letter:"A", text:"Flows deployed are inactive and need to be manually activated."},
      {letter:"B", text:"Flow allows only one version of the flow when deployed with a change set."},
      {letter:"C", text:"Deploying or redeploying a flow with change sets creates a version of the flow in the destination org."},
      {letter:"D", text:"All flow dependencies are automatically added to the change set."},
  ...
  },
  {
    ...
    text:"An administrator at Cloud kicks recently built a screen flow in a sandbox that creates a case and follow-up task. When the flow runs in the sandbox, it works just as expected. When tested in production, the flow errors when creating the records. What are two ways the administrator should troubleshoot the issue?",
    options:[
      {letter:"A", text:"Change the user experiencing the issue to the System Administrator profile."},
      {letter:"B", text:"Open the flow in Debug mode and run the Flow as another user."},
      {letter:"C", text:"Change the Default Case Creator to the user's manager."},
  ...
  },
  {
    ...
    text:"Cloud Kicks (CK) has a sneaker maintenance plan that it includes with all orders for Its new line of Bluetooth-enabled custom sneakers. The sneaker maintenance plan gives each customer 6 months of phone support in case they have Issues with their new sneakers. The administrator at CK is having a hard time keeping up with the work associated with managing the maintenance plan. What should the administrator do to help manage the plan?",
    options:[
      {letter:"A", text:"Use Flow to automatically create and assign entitlements."},
      {letter:"B", text:"Create a support process for the maintenance plan."},
      {letter:"C", text:"Ensure milestones are in place for the maintenance plan."},
  ...
  },
  {
    ...
    text:"Select power users want the ability to make configuration changes to a specific custom object. What tool should the administrator assign to the power users to enable this?",
    options:[
      {letter:"A", text:"View Setup and Configuration"},
      {letter:"B", text:"Delegated Administration"},
      {letter:"C", text:"Sharing Rule"},
  ...
  },
  {
    ...
    text:"Cloud Kicks has a very large knowledge base in Salesforce, Service reps are having a hard time finding the most relevant articles because there are too many search results. What should the administrator do to help service reps quickly narrow down the number of articles?",
    options:[
      {letter:"A", text:"Implement and configure Data Categories."},
      {letter:"B", text:"Delete and remove old Knowledge articles."},
      {letter:"C", text:"Update Knowledge to auto-search the case’s subject."},
  ...
  },
  {
    ...
    text:"An administrator is receiving cases that users are getting logged out of Salesforce without notice. What should the administrator do to address this issue?",
    options:[
      {letter:"A", text:"Deselect disable session timeout warning popup."},
      {letter:"B", text:"Select force logout on session timeout."},
      {letter:"C", text:"Remove the session timeout settings."},
  ...
  },
  {
    ...
    text:"The sales VP notices several sales reps generating a contract too early in the sales stage. To help correct this behavior, the VP has requested the Create Contract button only be available when the opportunity reaches the Negotiation stage. How should the administrator meet this requirement?",
    options:[
      {letter:"A", text:"Create a validation rule."},
      {letter:"B", text:"Configure dynamic action."},
  ...
  },
  {
    ...
    text:"Northern Trail Outfitters (NTO) wants to start using Salesforce for its HR recruiting process. NTO needs to ensure that every application is linked to both a job posting and an applicant. Applicants can apply for more than one job posting, and each job posting can have more than one application. How should an administrator configure the objects?",
    options:[
      {letter:"A", text:"Make Job Application as a junction object with a master-detail relationship to Applications and a lookup relationship to Job Posting."},
      {letter:"B", text:"Create Application as a junction object with a master-detail relationships to Job Postings and a lookup relationship to Job Applications."},
      {letter:"C", text:"Add applicants as a junction object with master-detail relationship to both Posting and Job Applications."},
  ...
  },
  {
    ...
    text:"When should an administrator apply a permission set to a user or group of users versus configuring the user’s profile with the necessary access?",
    options:[
      {letter:"A", text:"When a user is part of a team with an assigned profile that covers the majority of their needs but requires just a little less access than the rest of their team."},
      {letter:"B", text:"When a user is part of a team with an assigned profile that covers the majority of their needs but requires more access than the rest of their team."},
      {letter:"C", text:"When an organization’s sharing model is too broad and they need to restrict access beyond what their sharing model and existing profiles provide."},
  ...
  },
  {
    ...
    text:"Cloud Kicks has two record-triggered flows on the same object. One flow creates a child record when criteria are met. The second record-triggered flow is based on criteria to check if the child record exists and updates a field. The field on the child record that needs to be updated Is still null after the second record trigger. What should the administrator do to resolve this issue?",
    options:[
      {letter:"A", text:"Make a new record-triggered flow on the child object to update the field on the parent record."},
      {letter:"B", text:"Have the record-triggered flows fire on create or edit to update the field."},
      {letter:"C", text:"Combine the two flows into one with checks to see which part of the flow needs to be run."},
  ...
  },
  {
    ...
    text:"Cloud Kicks has updated several profiles and created a new app in the sandbox. After testing, everything is working as expected. Which two options should the administrator use to migrate these changes to production from the sandbox?",
    options:[
      {letter:"A", text:"Package deployment"},
      {letter:"B", text:"Change Data Capture"},
      {letter:"C", text:"Outbound Change Set"},
  ...
  },
  {
    ...
    text:"Cloud Kicks has created a new flow that deletes records. What should the administrator consider when testing the flow?",
    options:[
      {letter:"A", text:"Flows with delete elements cannot be debugged by the Flow debug tool."},
      {letter:"B", text:"Even if the flow is inactive, debugging the flow will delete the test record."},
      {letter:"C", text:"Records deleted by Flow when debugging are hard deleted."},
  ...
  },
  {
    ...
    text:"The administrator at Cloud Kicks made new fields and page layout adjustments based on new requirements from the service team. The changes have been built in a sandbox and are ready to be deployed into production. What should an administrator do before deploying the change set in production?",
    options:[
      {letter:"A", text:"Request a new sandbox based on the sandbox where the changes were made."},
      {letter:"B", text:"Make a new sandbox based on production to restore changes from."},
      {letter:"C", text:"Push the change set to another sandbox to restore from."},
  ...
  },
  {
    ...
    text:"At Cloud Kicks, the Sales team uses a specific dashboard to see how they are doing daily. The team has asked the administrator for an easier way to see this dashboard. What should the administrator recommend?",
    options:[
      {letter:"A", text:"Add the dashboard to the Sales team's home page."},
      {letter:"B", text:"Create a custom app with a dashboard."},
      {letter:"C", text:"Email the dashboard to the Sales Team every morning."},
  ...
  },
  {
    ...
    text:"Users at AW Computing use a custom object to manage orders. All profiles share a single page layout. Customer Service and Sales users express frustration overseeing actions that do not always apply to their situation on the page layout. What should an administrator recommend?",
    options:[
      {letter:"A", text:"Use Dynamic Actions and conditional visibility to show the appropriate actions to the applicable users."},
      {letter:"B", text:"Create separate record types for the Customer Service and Sales users' records."},
      {letter:"C", text:"Configure two separate permission sets and assign the appropriate permissions to each user."},
  ...
  },
  {
    ...
    text:"AW Computing has a 4-hour SLA in its support guarantee. The company recently received feedback that customers are reporting long wait times before an agent responds to a new case after it has been submitted. How should an administrator ensure cases are properly prioritized?",
    options:[
  ...
  },
  {
    ...
    text:"A user started to work remotely. They are having an issue logging in. What could be the issue?",
    options:[
      {letter:"A", text:"The login session has expired for this user."},
      {letter:"B", text:"They are signing in from a mobile device."},
      {letter:"C", text:"The time zone for the profile is outside of login hours."},
  ...
  },
  {
    ...
    options:[
      {letter:"A", text:"Create a new view in Identity Verification History, specifying Method."},
      {letter:"B", text:"Open the Login Access Policies in Setup which shows how many users are using MFA."},
      {letter:"C", text:"Run a session setting report, specifying login methods by user."},
  ...
  },
  {
    ...
    options:[
      {letter:"A", text:"Create a Hierarchical lookup on Account to track loan advisors' customers."},
      {letter:"B", text:"Set up Contacts to Multiple Accounts for loan advisors."},
      {letter:"C", text:"Use a B2B Account Model to track loan advisors' customers."},
  ...
  },
  {
    ...
    text:"Which two ways can an administrator review the page performance for a Lightning record page?",
    options:[
      {letter:"A", text:"Lightning Usage App"},
      {letter:"B", text:"Analyze Button"},
      {letter:"C", text:"Activation Button"},
  ...
  },
  {
    ...
    text:"The Cloud Kicks online Lead Intake form was recently updated to allow for new choices on some older picklist fields. The leads are all being created properly in Salesforce, but reps are getting errors as they try to work the leads. What tool should the administrator use to evaluate what is causing the errors?",
    options:[
      {letter:"A", text:"Login History"},
      {letter:"B", text:"Debug Log"},
      {letter:"C", text:"Setup Audit Log"},
  ...
  },
  {
    ...
    text:"Cloud Kicks (CK) has a field called Shoe Type Preference, CK's product team wants to see a report that groups specific picklist values together into one of two lists. What functionality should the administrator use to fulfill the team’s request?",
    options:[
      {letter:"A", text:"PREVGROUPVALUE"},
      {letter:"B", text:"Summary Formula"},
      {letter:"C", text:"Bucket field"},
  ...
  },
  {
    ...
    text:"The sales agents at DreamHouse Realty have a profile that allows them to import records for a custom object called House. The agents only need to make imports occasionally and typically import around 100 new records at a time. What tool should the agents use to upload records?",
    options:[
  ...
  },
  {
    ...
    text:"The administrator at Ursa Major Solar has set up IT policies for all user passwords to be a minimum length of 3 characters and have an expiration period of 90 days. The security team recently decided that administrators of any system should have a 15-character minimum password with a 30-day expiration period. Where should the administrator make this change?",
    options:[
      {letter:"A", text:"Organization-wide password policies"},
      {letter:"B", text:"Password complexity requirements on the permission set"},
      {letter:"C", text:"Password Policies on the System Administrator profile ."},
  ...
  },
  {
    ...
    text:"Cloud Kicks wants to force its users to set a value for a custom field called Tier by answering a series of questions. What two functions should the administrator use to ensure that users cannot bypass answering these questions in order to determine their Tier value.",
    options:[
      {letter:"A", text:"Set up a list view for the list of questions."},
      {letter:"B", text:"Make the field Read Only on the page layout."},
      {letter:"C", text:"Set up a restriction rule on the field."},
  ...
  },
  {
    ...
    text:"Cloud Kicks wants its sales reps to always use the same full zip code format with a hyphen where applicable. What should the administrator implement to help ensure consistent formatting?",
    options:[
      {letter:"A", text:"Edit the standard field length to five characters."},
      {letter:"B", text:"Add a quick create function for the sales reps to use."},
      {letter:"C", text:"Create a REGEX function to use in a validation rule on the field."},
  ...
  },
  {
    ...
    text:"An auto-response rule sends an email using Template1 when the field Case Source is 'email' and Template2 when Case Source is blank. A Process Builder updates Case Source to 'email' when a case is created using Email-to-Case and to 'web' when a case is created using Web-to-Case. Otherwise, Case Source is blank. What will occur when a case is created from an incoming email?",
    options:[
      {letter:"A", text:"Case Source updates to 'email' and an email is sent out using Template2."},
      {letter:"B", text:"An email is sent out using Template2 and then Case Source updates to 'email'."},
      {letter:"C", text:"An email is sent out using Template1 and then Case Source updates to 'email'."},
  ...
  },
  {
    ...
    text:"The administrator at Cloud Kicks has been asked to delete a large number of quote line items. They receive a .csv file with the record IDs to be deleted. The administrator uses Data Loader to delete them and selects Use Bulk API. When the job runs, every record shows an 'entity is deleted' error in the error file that is created. What is the reason for the error?",
    options:[
      {letter:"A", text:"The batch size selected was greater than the 200 record limit."},
      {letter:"B", text:"Deleting with Data Loader can only be done in Batch API mode."},
      {letter:"C", text:"One of the IDs in the batch referenced a record that was in the recycle bin."},
  ...
  },
  {
    ...
    options:[
      {letter:"A", text:"Use Process Automation Setting in Setup to the appropriate users or profiles."},
      {letter:"B", text:"Use a System permission that is assigned to the user or profile."},
      {letter:"C", text:"Use Apex Class Access to assign the Apex code to the user or profile."},
  ...
  },
  {
    ...
    text:"The sales team at Universal Containers has asked the administrator to build functionality to automatically update the account checkbox field 'Opportunity Created' to checked when at least one related opportunity has been created. What feature should the administrator use to build this functionality?",
    options:[
  ...
  },
  {
    ...
    text:"The AW Computing administrator team does significant amounts of work around process automation and ensuring data integrity. When an administrator created a new validation rule in production, the development team complained that their deployment to production failed. What should be implemented to prevent this conflict from happening?",
    options:[
      {letter:"A", text:"Review the setup audit trail prior to changes."},
      {letter:"B", text:"Refresh the full copy sandbox daily."},
      {letter:"C", text:"Test changes in a shared sandbox."},
  ...
  },
  {
    ...
    text:"An administrator has found a free app on the AppExchange and would like to install it. Which three items should the administrator take into consideration before installing the managed package? Choose 3 answers",
    options:[
      {letter:"A", text:"Custom objects and custom fields used by the app count against the org’s limits."},
      {letter:"B", text:"Managed apps do not undergo a formal security review by Salesforce."},
      {letter:"C", text:"Apps may require certain Salesforce editions or features to be enabled."},
      {letter:"D", text:"Apps may require external, third-party web services to function properly."},
  ...
  },
  {
    ...
    text:"An administrator at Universal Containers has been asked to configure product schedules. What should the administrator consider before enabling this feature?",
    options:[
      {letter:"A", text:"The Product Schedule is unavailable in Process Builder and Flow."},
      {letter:"B", text:"Line Item Schedule is unavailable in Process Builder and Workflow."},
      {letter:"C", text:"Customizable product schedule page layouts cannot be modified."},
  ...
  },
  {
    ...
    text:"At Cloud Kicks, users are able to run reports. However, when users try to export a report, they are taken to a login screen and prompted for additional verification. What is causing this issue?",
    options:[
      {letter:"A", text:"Users need to update their browser to the latest version."},
      {letter:"B", text:"The users are logged into an insecure network."},
      {letter:"C", text:"The users' profile is missing the Export Reports permission."},
  ...
  },
  {
    ...
    text:"Cloud Kicks has Service and Sales Manager roles that need to be able to see all Accounts. Currently, they each have their own custom profile. The organization-wide defaults are set to Private and a sharing rule shares access to Accounts to the sales and service teams based on criteria. What should the administrator do to allow the service and Sales Managers to see all Accounts?",
    options:[
      {letter:"A", text:"Configure a custom profile for each manager that gives them view All on Accounts."},
      {letter:"B", text:"Set the organization-wide default for Accounts to Public Read Only."},
      {letter:"C", text:"Create a permission set with view All to Accounts and assign it to the Service and Sales Managers."},
  ...
  },
  {
    ...
    text:"Sales reps and partner consultants at Cloud Kicks work on the same kinds of shoe deals. The administrator has been asked to ensure that the Profit field on the Opportunity object is available to sales reps and is hidden from partners using Field Level Security. Which two features should the administrator use to fulfil this request?",
    options:[
      {letter:"A", text:"Permission Set"},
  ...
  },
  {
    ...
    text:"An administrator is asked to create a report to calculate the year-over-year change in the dollar amount of a company’s opportunities. What reporting tool should be used to complete this request?",
    options:[
      {letter:"A", text:"A row-level formula to compare amounts grouped by year."},
      {letter:"B", text:"A joined report with two report blocks for each year"},
      {letter:"C", text:"A custom summary formula with PARENTGROUPVAL function"},
  ...
  },
  {
    ...
    text:"Universal Containers has found duplicate contacts in Salesforce. The sales team asked the administrator to prevent duplicate records from being created. Which two ways should the administrator customize duplicate management?",
    options:[
  ...
  },
  {
    ...
    text:"Ursa Major Solar (UMS) wants to improve Its customers’ ability to search for knowledge articles. UMS has already created categories for articles. Which two additional changes should be made to improve search capabilities?",
    options:[
      {letter:"A", text:"Configure Global Search for specific search terms."},
      {letter:"B", text:"Create synonyms for specific search terms."},
      {letter:"C", text:"Configure Einstein Search for specific search terms."},
  ...
  },
  {
    ...
    text:"Northern Trail Outfitters has many users set up as system administrators to perform Salesforce Administration. Which two functions would a delegated administrator be able to perform in order to help the existing Salesforce Administrator?",
    options:[
      {letter:"A", text:"Set up users and password management."},
      {letter:"B", text:"Configure updates to sharing rules."},
      {letter:"C", text:"Manage custom objects and customize nearly every aspect."},
  ...
  },
  {
    ...
    text:"An administrator needs to Import a large amount of historical data (more than 100,000 records) from another system. how should the administrator import the data?",
    options:[
      {letter:"A", text:"SOAP based API with Developer console"},
      {letter:"B", text:"Data Loader with Bulk API Enabled"},
      {letter:"C", text:"An AppExchange package"},
  ...
  },
  {
    ...
    text:"Cloud Kicks needs to automate several updates to lead records and update unrelated records. Select changes should happen every time a record is created or updated, But other changes should only happen when the record is updated. Which two options should the administrator use to automate these updates?",
    options:[
      {letter:"A", text:"Use a Decision element with the \"Only if the record that triggered the flow to run is updated to meet the condition requirements\" option."},
      {letter:"B", text:"Create a Process Builder that runs when a record is changed."},
      {letter:"C", text:"Create a flow that runs when a record is created or updated."},
  ...
  },
  {
    ...
    text:"An administrator needs to create a junction object called Account Region to link the standard Account object with a custom object called Region. Once the junction object is created, what are the next two steps the administrator should take?",
    options:[
      {letter:"A", text:"Make a master-detail relationship field on the junction object to the Region object."},
      {letter:"B", text:"Build a master-detail relationship field on the Region object to the junction object."},
      {letter:"C", text:"Create a master-detail relationship field on the Account object to the junction object."},
  ...
  },
  {
    ...
    text:"Ursa Major Solar offers customers annual service contracts. Account owners should receive an email renewal reminder 1 month before their customer's planned expiration date. The administrator builds a flow to automate the process, which runs when a record is created, and tests several possible scenarios. What will occur if the expiration date is changed from January 1 of the next year to yesterday?",
    options:[
      {letter:"A", text:"The flow is unable to run and a flow error message is sent to the user who initiates the flow."},
      {letter:"B", text:"The Interview resumes 1 month before the original expiration date and will send the email at that time."},
      {letter:"C", text:"The Interview is rescheduled based on the expiration date and sends the email on the last day of the current month."},
  ...
  },
  {
    ...
    options:[
      {letter:"A", text:"Person Account cannot be disabled."},
      {letter:"B", text:"Person Account requires less data storage."},
      {letter:"C", text:"Person Account and Business Accounts cannot be in the same sharing model."},
  ...
  },
  {
    ...
    text:"Which two tools should an administrator use to require data to be entered in a field and improve data quality on a record in Salesforce?",
    options:[
  ...
  },
  {
    ...
    text:"After setting up field history tracking on the Account object, the administrator for AW Computing wants to retrieve the field history data for analysis. how should the administrator acquire this data?",
    options:[
      {letter:"A", text:"Create a report of Accounts and export it to Excel."},
      {letter:"B", text:"Query and export the Account History object using Data Loader."},
      {letter:"C", text:"Use the Data export service in setup."},
  ...
  },
  {
    ...
    text:"A sales user is assigned to a permission set group that gives them Modify All access to Accounts. An administrator assigns the same user to a muting permission set that mutes Deletes access on Account. What level of access will the sales user have on the Account object?",
    options:[
      {letter:"A", text:"Read-only"},
      {letter:"B", text:"Modify All"},
      {letter:"C", text:"Read, Create, and Edit"},
  ...
  },
  {
    ...
    text:"An administrator has been tasked with creating a new custom field on the Account object called Government ID. The compliance department has determined that this field contains sensitive information and needs to be encrypted using Classic Encryption. How will this impact users when reading, editing, or reporting on Accounts?",
    options:[
      {letter:"A", text:"Encrypted fields are unable to be used in report criteria or list view filters."},
      {letter:"B", text:"Users will need the View Encrypted Data permission to edit the field."},
      {letter:"C", text:"Encrypted fields can be added to a list view and rule filters."},
  ...
  },
  {
    ...
    text:"DreamHouse Realty has a rental team and a real estate team. The two teams have different sales processes and capture different client information on their opportunities. How should an administrator extend the Opportunity object to meet the teams' different needs?",
    options:[
      {letter:"A", text:"Leverage Opportunities for the Real Estate Team and create a new custom object for the Rental Team Opportunities."},
      {letter:"B", text:"Use separate record types, page layouts, and sales processes for the Rental and Real Estate Teams."},
      {letter:"C", text:"Create Opportunity Teams for the Rental and Real Estate Teams and make appropriate fields visible to only the necessary team."},
  ...
  },
  {
    ...
    text:"The Cloud Kicks administrator wants to open up opportunity sharing to directors who oversee regional managers so they can access records to assist regional managers. What sharing mechanism should be used?",
    options:[
      {letter:"A", text:"organization wide Defaults"},
      {letter:"B", text:"Role Hierarchy"},
      {letter:"C", text:"Manual Sharing"},
  ...
  },
  {
    ...
    text:"An administrator created a new custom object. When trying to upload new records to the custom object using Data Loader, they are unable to see the new custom object in the list of available objects. What should the administrator do to resolve the issue?",
    options:[
      {letter:"A", text:"Assign a permission set to give them access to the new object."},
      {letter:"B", text:"Check the Field-Level Security of the new custom object’s Name field."},
      {letter:"C", text:"Ensure Allow Sharing is checked on the custom object."},
  ...
  },
  {
    ...
    text:"DreamHouse Realty has created a custom object to track its Open Houses with a master-detail relationship up to a custom object for Properties. Agents need to quickly calculate the number of Open House records in a status of Pending so they can see the value from the Property record. What feature should the administrator implement?",
    options:[
      {letter:"A", text:"Lightning Component"},
      {letter:"B", text:"Formula Fields"},
  ...
  },
  {
    ...
    text:"Users report that the industry picklist field is no longer visible on account records. What tool can an administrator use to troubleshoot the issue?",
    options:[
      {letter:"A", text:"Field audit history"},
  ...
  },
  {
    ...
    text:"AW Computing wants to embed a report chart on the Account record page that shows the value of closed sales for that account. The chart should be limited to users in the Sales Manager role on the Account record pages. How should this be accomplished?",
    options:[
      {letter:"A", text:"Create a new report and assign it to the component."},
      {letter:"B", text:"Create a new page layout for the Sales Manager role."},
      {letter:"C", text:"Filter component visibility for the Account ID."},
  ...
  },
  {
    ...
    text:"What should an administrator use as an alternative to a Process Builder to expedite the time required to update the records?",
    options:[
      {letter:"A", text:"Before save Flow Trigger"},
      {letter:"B", text:"Batch Update"},
      {letter:"C", text:"Workflow Rule Field Change"},
  ...
  },
  {
    ...
    text:"How should an administrator ensure the appropriate number of digits are entered into the custom encrypted field created to capture credit card numbers on the Opportunity object?",
    options:[
      {letter:"A", text:"Use the credit card number mask type."},
      {letter:"B", text:"Define the number of mask characters."},
      {letter:"C", text:"Enter the number of digits at the field level."},
  ...
  },
  {
    ...
    text:"An administrator is using the Dev Console Log Inspector to troubleshoot a Process Builder. What event type should the administrator look for in the event column?",
    options:[
      {letter:"A", text:"Event types beginning with FLOW"},
      {letter:"B", text:"Event types beginning with AUTOMATED."},
      {letter:"C", text:"Event types beginning with WORKFLOW"},
  ...
  },
  {
    ...
    text:"A user at Cloud Kicks has informed the administrator that they are unable to log in to Salesforce via multi-factor authentication. Which two areas should the administrator review to understand potential root causes?",
    options:[
      {letter:"A", text:"Identity Verification History"},
      {letter:"B", text:"Login History"},
      {letter:"C", text:"Debug Logs"},
      {letter:"D", text:"Setup Audit Trail"}
    ],
    answer:["A", "B"], multi:true,
  ...
  },
  {
    ...
    text:"Sales reps at AW Computing have asked the Administrator to help them close deals faster on the Salesforce mobile app when they're in the field. They want to be able to quickly close an opportunity and have key fields, like status, pre-populated to Closed Won. What should an administrator create to achieve this?",
    options:[
      {letter:"A", text:"Object-specific Quick Action"},
      {letter:"B", text:"Global Quick Action"},
      {letter:"C", text:"Lightning Component"},
  ...
  },
  {
    ...
    text:"Sales reps at AW Computing have been reporting that contact phone numbers sometimes revert back to an old value after being updated. What should the administrator do to resolve this issue?",
    options:[
      {letter:"A", text:"Schedule Apex jobs."},
      {letter:"B", text:"Delete all workflow rules."},
      {letter:"C", text:"Add an invocable process."},
  ...
  },
  {
    ...
    options:[
      {letter:"A", text:"A primary Account relationship Is required on a Contact regardless of the page layout settings."},
      {letter:"B", text:"The Contact has Indirect relationships to other Accounts."},
      {letter:"C", text:"The Account Contact relationship record needs to be deleted first In order to disassociate Contact from the Account."},
  ...
  },
  {
    ...
    options:[
      {letter:"A", text:"Read access will be lost to the record."},
      {letter:"B", text:"Edit access will be lost to the record."},
      {letter:"C", text:"Record Access remains the same."},
  ...
  },
  {
    ...
    text:"Ursa Major Solar has a junction object that connects Bots with Solar Panels. The administrator needs users to be able to see all the solar panels that a Bot is related to. Users already have access to the Bot and the Junction, but not the Solar Panel object. What access does the user need to be able to see the solar panel records?",
    options:[
      {letter:"A", text:"Read permission is required on both master records."},
      {letter:"B", text:"Access permission Is not required on either master record."},
      {letter:"C", text:"Create permission Is required on both master records."},
  ...
  },
  {
    ...
    text:"The VP of sales at AW Computing utilizes a Lead report grouped by Country and Lead Source to show where the leads are coming from. The number of leads varies greatly for each Country. What should the administrator configure on the report to show the Lead Source effectiveness for each country?",
    options:[
      {letter:"A", text:"The 'Show Unique Count' option"},
      {letter:"B", text:"PARENTGROUPVAL Function"},
      {letter:"C", text:"Bucket filters"},
  ...
  },
  {
    ...
    options:[
      {letter:"A", text:"Select the Debug Enabled checkbox on platform events,"},
      {letter:"B", text:"Platform events are unavailable for debugging."},
      {letter:"C", text:"Set a debug log on the Automated Process entity."},
  ...
  },
  {
    ...
    text:"AW Computing sells a variety of software programs for Its customers to choose from. Management wants to ensure that the customer automatically receives phone support when they purchase photo editing software. how should an administrator meet these requirements?",
    options:[
      {letter:"A", text:"Add an entitlement template to the purchased product for phone support."},
      {letter:"B", text:"Include a milestone to the product with a term of 365 days for phone support."},
      {letter:"C", text:"Configure a flow to create a milestone on the asset upon purchase."},
  ...
  },
  {
    ...
    options:[
      {letter:"A", text:"Go into the user record and uncheck the Lightning User checkbox."},
      {letter:"B", text:"Go into the user record and freeze the user."},
      {letter:"C", text:"Go into the user record and set the login hours to 'None'."},
  ...
  },
  {
    ...
    text:"A user is getting an error when attempting to merge two accounts. The administrator checks the profile to see the user has Read/Write permission on Accounts and is the owner of both records. What is preventing the user from completing the merge?",
    options:[
      {letter:"A", text:"Only administrators have permission to merge records."},
      {letter:"B", text:"The user is assigned to the wrong territory."},
      {letter:"C", text:"The Account matching rules are not set."},
  ...
  },
  {
    ...
    text:"Users are complaining that a record page is taking too long to load. What are three options available to the administrator to help with this issue? Choose 3 answers",
    options:[
  ...
  },
  {
    ...
    options:[
      ...
      {letter:"B", text:"Check the Reevaluate Workflow Rules After Field Change box on the Approval Process Field Update Action."},
      {letter:"C", text:"Turn on Recursion in the Process Builder under the Advanced Settings so the Process Builder fires again."},
  ...
  },
  {
    ...
    text:"The support operations team has noticed some invalid data in the custom Primary issue picklist field on case records. They are unsure of what the issue is since the field is being updated by an automated procedure and there is a validation rule to ensure clean data on case records. Why are records being updated with data that violates the validation rule?",
    options:[
      {letter:"A", text:"The data change is triggered by an update record Flow element."},
      {letter:"B", text:"The field is being updated by a workflow field update."},
      {letter:"C", text:"The field is being updated by an Apex before trigger."},
  ...
  },
  {
    ...
    text:"A sales rep at Ursa Major Solar was assigned to a role under their manager and is the record owner of several opportunities; however, the sales rep is missing from the manager's forecast. What should the administrator review to solve this issue?",
    options:[
      {letter:"A", text:"Enable owner adjustment"},
      {letter:"B", text:"Enable manager adjustments"},
      {letter:"C", text:"Allow Forecasting"},
  ...
  },
  {
    ...
    options:[
      {letter:"A", text:"Run the standard Data Classification report."},
      {letter:"B", text:"Create a custom Entity Definition and Field Definitions report type."},
      {letter:"C", text:"Use the Data Classification Metadata list view."},
  ...
  },
  {
    ...
    text:"Support staff at Cloud Kicks work on multiple accounts and opportunities at the same time, Currently, they are switching between browser tabs, which is tedious and confusing. Support managers put in a request for a better agent experience. What should an administrator recommend?",
    options:[
      {letter:"A", text:"Create a screen flow to pull all related opportunities onto one page."},
      {letter:"B", text:"Enable Subtab Record Browsing in the Setup menu."},
      {letter:"C", text:"Configure Split List Views."},
  ...
  },
  {
    ...
    text:"AW Computing (AWC) has customers In multiple countries. AWC would like to set up advanced currency management for Its system. Which two considerations should AWC be aware of prior to implementing this change to the existing system?",
    options:[
      {letter:"A", text:"When a currency is added to an organization's List of supported currencies, it cannot be deleted."},
      {letter:"B", text:"Opportunities will only display sales In the customer's localized currency."},
      {letter:"C", text:"Historical trend reports will only use the last dated exchange rate."},
  ...
  },
  {
    ...
    text:"Cloud Kicks has a custom object called Membership Details that records information about customers' preferences for their memberships. Depending on the membership level, different data needs to be displayed. • when the running user has the Marketing profile, all data should be visible. • When the running user has the Support profile, only the Support preference fields should be visible. • Both Marketing and Support users should be able to report on all data. How should the administrator deliver this solution?",
    options:[
      {letter:"A", text:"Create two record types und two page layouts."},
  ...
  },
  {
    ...
    options:[
      ...
      {letter:"C", text:"Remove any existing data in the lookup field on Potential Name records"},
  ...
  },
  {
    ...
    text:"An administrator at Cloud Kicks has been tasked by the compliance team to flag where sensitive information is stored in Salesforce. What feature should the administrator use to fulfill this requirement?",
    options:[
      {letter:"A", text:"Data Classification"},
      {letter:"B", text:"Schema Builder"},
      {letter:"C", text:"Classic Encryption"},
  ...
  },
  {
    ...
    text:"Cloud Kicks (CK) wants the forecast numbers to be shown by territory regardless of who owns the record. CK also wants a way to forecast based on role hierarchy. Which three options should an administrator recommend? Choose 3 answers",
    options:[
      {letter:"A", text:"Have the user select the forecast type listed under the Forecast Type in the Display Settings."},
      {letter:"B", text:"Enable Territory Forecast."},
      {letter:"C", text:"Make a custom field to track the amounts for Territory and Hierarchy Forecast."},
      {letter:"D", text:"Modify the Territory Forecast to match the Hierarchy Forecast model."},
  ...
  },
  {
    ...
    text:"An administrator is given a .csv file of 5,000 leads with External Id and Status fields. They need to match existing and add new records with Data Loader. What action should be taken to populate the Status field on the records and add new records?",
    options:[
      {letter:"A", text:"Export"},
  ...
  },
  {
    ...
    text:"Cloud Kicks (CK) does business directly with individual consumers (B2C) and large businesses (B2B). Some of CK's B2C customers are employed at its larger customer accounts and should be tracked under both. Which two options will CK need to use to manage its customers' accounts?",
    options:[
      {letter:"A", text:"Contacts to Multiple Accounts"},
      {letter:"B", text:"Leads"},
      {letter:"C", text:"Person Accounts"},
  ...
  },
  {
    ...
    text:"Ursa Major Solar's administrator has configured multiple record-triggered flows to run before or after the record is saved on the Account object. What should the administrator consider when a record-triggered flow executes first?",
    options:[
      {letter:"A", text:"Assign the highest priority to the record-triggered flow which should execute first."},
      {letter:"B", text:"The flow with the longest execution time will execute first."},
      {letter:"C", text:"The flow with the shortest execution time will execute first."},
  ...
  },
  {
    ...
    text:"An administrator is creating a custom Opportunity record page for Sales users for new logo opportunities. They need to control what fields display on the record when a sales user is viewing the opportunity. Where should the administrator edit what fields display in the details of the record page?",
    options:[
      {letter:"A", text:"Record Detail Component"},
      {letter:"B", text:"Custom Lightning Component"},
  ...
  },
  {
    ...
    text:"The Service team at Cloud Kicks needs a way to show the current status from the Account on the Case. This value should be on the page and is used in validation rules. What should the administrator recommend to solve this?",
    options:[
      {letter:"A", text:"Create a cross-object formula."},
      {letter:"B", text:"Use a picklist field."},
      {letter:"C", text:"Make a Rollup Summary."},
  ...
  },
  {
    ...
    text:"An administrator has a request to create a Next Steps field for users to document what they need to do next on a lead. The field should allow users to format the text and be mapped to an opportunity when converted. What type of field will satisfy these requirements?",
    options:[
      {letter:"A", text:"Formula (Text)"},
      {letter:"B", text:"Text Area (Long)"},
      {letter:"C", text:"Text Area"},
  ...
  },
  {
    ...
    options:[
      ...
      {letter:"B", text:"Delegated Administrator"},
  ...
  },
  {
    ...
    text:"Cloud Kicks has just released a new Process Builder on the Account in production. The end users keep getting error messages that prevent them from completing their updates to the Account. Which three things should the administrator do to resolve this issue? Choose 3 answers",
    options:[
      {letter:"A", text:"Review the Error Email for the Process Builder and rectify the issues."},
      {letter:"B", text:"Manually make the updates to the Account as the logged-in user."},
      {letter:"C", text:"Deactivate the Process Builder in production."},
      {letter:"D", text:"Have the users refresh the Account page so they get the current Process Builder."},
  ...
  },
  {
    ...
    text:"A new administrator at Cloud Kicks has reported that they are unable to use outbound change sets as requested. What permission should be reviewed to determine if it is missing from the administrator user or profile?",
    options:[
      {letter:"A", text:"Create and Upload Change Sets"},
      {letter:"B", text:"Modify Metadata Through Metadata API Functions"},
      {letter:"C", text:"Deploy Change Sets"},
  ...
  },
  {
    ...
    text:"Cloud Kicks maintains Inventory in a legacy application. Management wants the information to also be available to view and report on in Salesforce. Which action should the administrator take to achieve this goal?",
    options:[
      {letter:"A", text:"Create an external object that maps to the inventory application."},
      {letter:"B", text:"Import the data into a custom object when needed; delete after it is used."},
      {letter:"C", text:"Build a Lightning component and use SFDX to connect to the inventory app."},
  ...
  },
  {
    ...
    text:"Northern Trail Outfitters (NTO) has a private sharing model for records containing a customer's credit information. These records should be visible to a sales rep's manager but hidden from their colleagues. How should an administrator adjust NTO's sharing model to ensure the correct amount of confidentiality?",
    options:[
      {letter:"A", text:"Use validation rules targeting the logged-in user."},
      {letter:"B", text:"Add View All access for the object via the managers profile."},
      {letter:"C", text:"Create sharing rules for each manager based on the record owner."},
  ...
  },
  {
    ...
    text:"The administrator at AW Computing implements multi-factor authentication using the Salesforce Authenticator app downloaded on company-provided iPhones. A sales rep breaks their phone and needs to update an opportunity record. How should the administrator grant access for the sales rep?",
    options:[
      {letter:"A", text:"Instruct the sales rep to log in from the company's VPN."},
      {letter:"B", text:"Delegate multi-factor identification to the sales rep."},
      {letter:"C", text:"Add the sales rep's IP address to the trusted IP ranges."},
  ...
  },
  {
    ...
    text:"How should an administrator support a finance team that is trying to use Opportunity data to keep an eye on their pipeline rather than manually calculating anticipated income for the quarter?",
    options:[
      {letter:"A", text:"Run a report at the end of each quarter to update the finance team on pipeline status."},
      {letter:"B", text:"Set up collaborative forecasting to view quota against the open pipeline."},
      {letter:"C", text:"Create a custom Forecasting object to inform the finance team on the status of deals."},
  ...
  },
  {
    ...
    text:"Ursa Major Solar has a training sandbox with 160MB of test data that needs to be refreshed every other day. Which two sandboxes should be used in this instance?",
    options:[
      {letter:"A", text:"Partial"},
  ...
  },
  {
    ...
    text:"What should an administrator consider when using Person Accounts?",
    options:[
      {letter:"A", text:"In a complex business model and the users find it easiest to record Opportunity information on Contacts rather than Accounts."},
      {letter:"B", text:"In a B2B business model and is selling to the primary contact at a business organization."},
      {letter:"C", text:"In a B2C business model and the consumer is the intended recipient of sales and marketing attention."},
  ...
  },
  {
    ...
    options:[
      {letter:"A", text:"Require a Username, Password, and Security Token when logging in."},
      {letter:"B", text:"Set up an authentication provider for reports and dashboards."},
      {letter:"C", text:"Require MFA when users need to view and export dashboards and reports."},
  ...
  },
  {
    ...
    text:"A sales manager at AW Computing has created a contact record but is missing some of the information to complete the record. The organization-wide default for Accounts is set to Public Read Only, and Contacts are controlled by parent. Who will be able to edit this new contact record?",
    options:[
      {letter:"A", text:"Users above the sales manager in the role hierarchy"},
      {letter:"B", text:"All users in the organization"},
      {letter:"C", text:"The owner and users below the owner in the role hierarchy"},
      {letter:"D", text:"The record owner only"},
  ...
  },
  {
    ...
    text:"AW Computing has several service plans it offers with its laptops. Management wants the sales team to focus on bringing in new business and to have the creation of the renewal opportunity for the service plans happen automatically. What approach should the administrator take to automate the renewal process?",
    options:[
      {letter:"A", text:"Configure a time-based workflow to send an email reminder to the sales rep when the service plan expires."},
      {letter:"B", text:"Create a dynamic Lightning page with rich text to remind the rep to create a renewal opportunity when the opportunity is closed won."},
      {letter:"C", text:"Create a validation rule to prevent the rep from closing the opportunity until a renewal is associated."},
  ...
  },
  {
    ...
    text:"The sales team at Cloud Kicks is noticing that sales reps are misusing the new Screen Flow tool for data entry, since they are shown the initial screen after clicking Finish. What should the administrator do to fix this?",
    options:[
      {letter:"A", text:"Use a lightning action to redirect the user"},
      {letter:"B", text:"Create a new flow to redirect the user when the other flow finishes."},
      {letter:"C", text:"Add a trigger to redirect the user to a new page."},
  ...
  },
  {
    ...
    text:"Ursa Major Solar customer records have a lot of fields and Lightning components to give users a variety of information and available functions. Recently, users have noted that their pages take a long time to load and it's starting to negatively impact their experience. What should the administrator do to help diagnose where improvements can be made?",
    options:[
      {letter:"A", text:"Check the debug logs found in the Environment section of Setup."},
      {letter:"B", text:"Click Analyze from the Lightning App Builder toolbar."},
      {letter:"C", text:"Review the debug logs from the Developer Console."},
  ...
  },
  {
    ...
    text:"The administrator at Cloud Kicks needs to import a batch of person accounts into Salesforce. What tool should the administrator use?",
    options:[
      {letter:"A", text:"Data Import Wizard"},
      {letter:"B", text:"Quick Create"},
  ...
  },
  {
    ...
    text:"An administrator created and activated several record-triggered flows that are configured to run before the record is saved on the same object. What should the administrator consider about the order of execution for flows?",
    options:[
      {letter:"A", text:"The flow type will determine the order of execution."},
      {letter:"B", text:"The last created date of the flow will determine the order."},
      {letter:"C", text:"The order of flow execution is unpredictable."},
  ...
  },
  {
    ...
    text:"On the Planet custom object, Ursa Major Solar's sales director wants only certain action buttons to appear depending on if a given planet is defined as gaseous. In which Lightning component should the administrator define dynamic action buttons?",
    options:[
      {letter:"A", text:"Record Detail"},
  ...
  },
  {
    ...
    text:"At Ursa Major Solar, several different planetary teams handle leads depending on which planet the lead is coming from. While most of the teams only need a few fields filled out to work the lead, the Jupiter team requires additional information to be filled out, such as which moon the lead is coming from. The administrator needs to automate which team is allocated the lead record based on the planet and ensure that every team has all of the information they need. Which two features will satisfy these requirements?",
    options:[
      {letter:"A", text:"Assignment Rules"},
      {letter:"B", text:"Validation Rules"},
      {letter:"C", text:"Matching Rules"},
      {letter:"D", text:"Workflow Rules"}
    ],
    answer:["A", "B"], multi:true,
  ...
  },
  {
    ...
    text:"AW Computing is conducting an audit and wants to understand how many objects have been shared as public externally. which tool should the administrator use to quickly obtain these details?",
    options:[
      {letter:"A", text:"Security Health Check"},
      {letter:"B", text:"Setup Audit Trail"},
      {letter:"C", text:"Session Security Settings"},
  ...
  },
  {
    ...
    text:"When configuring a change set, which two practices should an administrator adhere to in order to ensure a successful deployment to production?",
    options:[
      {letter:"A", text:"Clone a change set to add forgotten dependent components to an uploaded change set."},
      {letter:"B", text:"Add permissions and access settings to outbound change sets in addition to the dependent component list."},
      {letter:"C", text:"Run deployment validations on the change set in the sandbox prior to uploading to production."},
  ...
  },
  {
    ...
    text:"The administrator at AW Computing has received an email for a system error indicating that their organization has reached its hourly limit processing workflow time triggers. Which two processes should the administrator review?",
    options:[
      {letter:"A", text:"Time-Based Workflows"},
      {letter:"B", text:"Paused Flow Interviews"},
  ...
  },
  {
    ...
    text:"Users at AW Computing are receiving a duplicate message when they enter contacts with common first and last names. Management wants to improve the user experience but also keep the data Integrity of contacts. What should an administrator implement for this issue?",
    options:[
      {letter:"A", text:"Update the matching method on the rule from fuzzy to exact for First Name and Last Name."},
      {letter:"B", text:"Change the duplicate rule to report Instead of alert so the message is avoided."},
      {letter:"C", text:"Include the Email field to the existing matching rule for a more exact match."},
  ...
  },
  {
    ...
    text:"A user at Ursa Major Solar is experiencing a flow error while trying to process a record to the next status. The users with the same access can process records without any errors. What should the administrator do to troubleshoot the issue?",
    options:[
      {letter:"A", text:"Use the flow debug option and set the selection to Run as another user."},
      {letter:"B", text:"Grant the user more data access by moving them higher in the role hierarchy."},
      {letter:"C", text:"Change the flow to run as System Context Without Sharing - Access All Data."},
  ...
  },
  {
    ...
    text:"At Ursa Major Solar, there is an account owned by a user with the role of Galaxy manager. Two users with the same profile are both assigned to the sub-role, Galaxy Subordinate. However, only one can access the account. What is the reason only one user can see the account record?",
    options:[
      {letter:"A", text:"Workflow Rule"},
      {letter:"B", text:"Manual Sharing"},
  ...
  },
  {
    ...
    text:"Universal Containers wants to assign a task due date on one of two fields. Estimated Shipping Date or Client Need By Date, which is further in the future. Which two combined automation tools should the administrator use to create the task record and assign based on date criteria?",
    options:[
      {letter:"A", text:"Create a formula to capture the MAX date."},
      {letter:"B", text:"Make a Process Builder to create the task."},
      {letter:"C", text:"Design an approval process to capture the furthest date."},
  ...
  },
  {
    ...
    text:"At Cloud Kicks, the distributor account information is sensitive information. The administrator needs to make sure this information is unavailable to testers in the full sandbox. What should the administrator recommend?",
    options:[
      {letter:"A", text:"Refresh the sandbox."},
      {letter:"B", text:"Assign the users a new permission set."},
      {letter:"C", text:"Use the data masking tool."},
  ...
  },
  {
    ...
    text:"An administrator at Cloud Kicks has been asked to reduce the file size of full data exports in order to have quicker exports. Which three recommendations should the administrator make? Choose 3 answers",
    options:[
      {letter:"A", text:"Reduce the amount of objects per export."},
      {letter:"B", text:"Request a backup file every 5 days."},
      {letter:"C", text:"Deselect ‘Include images, documents, and attachments’ in the export."},
      {letter:"D", text:"Unselect the recycle bin in the object export option."},
  ...
  },
  {
    ...
    text:"Cloud Kicks (CK) completed a project in a sandbox environment and wants to migrate the changes to production. CK split the deployment into two distinct change sets. Change set 1 has new custom objects and fields. Change set 2 has updated profiles and automation. What should the administrator consider before deploying the change sets?",
    options:[
      {letter:"A", text:"The Field-Level Security will not be deployed with the profiles in change set 2."},
      {letter:"B", text:"Change set 2 needs to be deployed first."},
      {letter:"C", text:"Automations need to be deployed in the same change set in order to be activated."},
  ...
  },
  {
    ...
    text:"What should an administrator do to keep secure fields protected in email templates?",
    options:[
      {letter:"A", text:"Implement GDPR."},
      {letter:"B", text:"Set up an approval process for email alerts."},
      {letter:"C", text:"Remove the fields from the email."},
  ...
  },
  {
    ...
    text:"The administrator at Cloud Kicks (CK) is troubleshooting why users are missing expected email alerts from an automated process. The investigation shows that CK is hitting its daily limit. What should the administrator review to resolve the issue?",
    options:[
      {letter:"A", text:"Email Logs"},
      {letter:"B", text:"HTML Email Status Report"},
      {letter:"C", text:"Notification Delivery Settings"},
  ...
  },
  {
    ...
    text:"A previous consultant helped Universal Containers automate many of its business processes. The administrator changed the email address on the consultant's user record and deactivated it. The consultant called to say they continue to get email messages from failed flows and processes. What steps should the administrator perform to stop the fault messages from going to the consultant?",
    options:[
      {letter:"A", text:"Create a custom metadata type and associate the LastModifiedBy field. Write a flow that updates the field in any flows or processes equal to the consultant's name."},
      {letter:"B", text:"Request an Email Log from Email Log Files in Setup and filter the request by the consultant's email. Manually update any flows or processes listed on the log."},
      {letter:"C", text:"Set Send Process or Flow Error Email' to Apex Exception Email Recipients' in Automation settings. Add the System Admin's email to the Apex Exception Email page in Setup."},
  ...
  },
  {
    ...
    text:"Cloud Kicks is a large company with many divisions. Some divisions have a higher turnover, so each division wants to be able to create and manage users only within their division. What should the administrator do to set this up?",
    options:[
      {letter:"A", text:"Set up delegated administrators for the division leaders."},
      {letter:"B", text:"Assign a flat territory role hierarchy for the divisions."},
      {letter:"C", text:"Create a permission set group for the division leaders."},
  ...
  },
  {
    ...
    options:[
      {letter:"A", text:"Identity Verification History stores the last year's worth of data."},
      {letter:"B", text:"User belongs to a specific role for which identity verification data is not stored."},
      {letter:"C", text:"Up to 20,000 records of users' identity verification attempts are stored."},
  ...
  },
  {
    ...
    text:"Ursa Major Solar has a global customer base. Recent issues with customs have greatly delayed shipping to Canadian customers. While the Country field is already on the page layout, the sales team wants Canadian customers highlighted as a potential challenge for fulfillment until the shipping issue is resolved. How should the administrator solve this issue?",
    options:[
      {letter:"A", text:"Modify the page layouts to move the Country field into its own section."},
      {letter:"B", text:"Add a rich text component to the Lightning page. Use conditional visibility to only show the component if the account is Canadian."},
      {letter:"C", text:"Create an in-app guidance prompt for Canadian records."},
  ...
  },
  {
    ...
    text:"The distributors at Cloud Kicks are eligible for support based on a specific service contract. How should the administrator show this in Salesforce?",
    options:[
      {letter:"A", text:"Use entitlement management."},
      {letter:"B", text:"Add a service contract to the record."},
      {letter:"C", text:"Turn on Service Cloud."},
  ...
  },
  {
    ...
    text:"An administrator has been tasked with sending an email notification to all project team members when project status is changed to Allocated. Project teams contain users from different departments and different roles. How should an administrator ensure the proper users will receive the email?",
    options:[
      {letter:"A", text:"Configure a queue for the project team and have members view the queue's list view."},
      {letter:"B", text:"Use sharing rules to automatically share with the individual users in the project team."},
      {letter:"C", text:"Move the project users to the same role and send the email alert to everyone in the role."},
  ...
  },
  {
    ...
    text:"An administrator at AW Computing noticed that a custom field on the Contact object was changed from text to text area. What tool should the administrator use to investigate this change?",
    options:[
      {letter:"A", text:"Developer Console"},
      {letter:"B", text:"Field History Tracking"},
      {letter:"C", text:"Debug Log"},
  ...
  },
  {
    ...
    text:"A sales rep needs to help cross-sell an opportunity but is unable to make updates on the record or update the opportunity team. Which two options would be required for a sales rep to add a rep to the opportunity team?",
    options:[
      {letter:"A", text:"Transferred ownership of the Opportunity to the sales rep"},
      {letter:"B", text:"A permission with Edit access on the Account object"},
      {letter:"C", text:"A role above the Opportunity owner in the role hierarchy"},
  ...
  },
  {
    ...
    text:"Sales managers at Ursa Major Solar have asked for some additional automation around opportunity reminders. If the opportunity is in the Proposal stage a week before the close date, they want an email sent to the opportunity owner and manager. If the Budget Approved custom field is checked, the managers want to be notified immediately. How should these requirements be met without using code?",
    options:[
      {letter:"A", text:"Create a schedule-triggered flow. Configure the trigger to flow weekly."},
      {letter:"B", text:"Create a record-triggered flow with scheduled paths. Configure the trigger to flow after the record is saved."},
      {letter:"C", text:"Create a record-triggered flow with scheduled paths. Configure the trigger to flow before the record is saved."},
  ...
  },
  {
    ...
    text:"An administrator has a request to write a report listing accounts that have sales from this year and that have a completed activity in the last 30 days. What reporting feature should the administrator employ to provide only the list of accounts, without listing the details of the opportunities?",
    options:[
      {letter:"A", text:"Joined Report"},
      {letter:"B", text:"Cross-Filter"},
      {letter:"C", text:"Summary Report"},
  ...
  },
  {
    ...
    text:"Cloud Kicks wants to implement multi-factor authentication (MFA) to help better secure its Salesforce org. Which two options should the administrator consider to use MFA?",
    options:[
      {letter:"A", text:"An Authentication App"},
      {letter:"B", text:"A Username and Password"},
      {letter:"C", text:"A Security Token"},
  ...
  },
  {
    ...
    options:[
      ...
      {letter:"B", text:"Make sure the price book Is in the company currency."},
  ...
  },
  {
    ...
    text:"The administrator at AW Computing has been asked to review whether any users are making configuration changes directly in production. Which item should the administrator review to find these details?",
    options:[
      {letter:"A", text:"Setup Audit Trail"},
      {letter:"B", text:"Field History Tracking"},
      {letter:"C", text:"Login History"},
  ...
  },
  {
    ...
    text:"Universal Containers' support team wants to use Salesforce Knowledge to allow customers and the support team to have access to the product documentation. There are many different types of documentation with usage across the globe. What feature should the administrator configure?",
    options:[
      {letter:"A", text:"Enable the Case Feed."},
      {letter:"B", text:"Create article types."},
      {letter:"C", text:"Define data categories and visibility."},
  ...
  },
  {
    ...
    text:"Northern Trail Outfitters requires the sales user to input a use case before moving the opportunity stage to qualified. A consultant has reviewed the business requirement and ran a report to check the state of data completion. When pulling a report for opportunities in the qualified stage or beyond, it appears that only 30% of records have a use case filled out with varying text strings. What should the administrator recommend?",
    options:[
      {letter:"A", text:"Write a record-triggered flow that populates the Use Case field when an opportunity is closed."},
      {letter:"B", text:"Create a validation rule and add the Use Case field to the Stage Guidance in Path."},
      {letter:"C", text:"Make the Use Case field required on the master Opportunity layout."},
  ...
  },
  {
    ...
    text:"The finance director at Cloud Kicks asks the administrator for an exception report that shows all B2C accounts that are missing the credit card number. The credit card number is a classic encrypted field. What action should the administrator take to meet this requirement?",
    options:[
      {letter:"A", text:"Add 'View Encrypted Fields' to a permission set assigned to Finance and system administrators and a summary report filtered by credit card number."},
      {letter:"B", text:"Unmask the encrypted credit card number field to make it available and add a custom filter to a report where credit card number is blank."},
      {letter:"C", text:"Build a custom checkbox called Has Credit Card' that Finance checks when a credit card is recorded and a tabular report filtered on the checkbox equal to false."},
  ...
  },
  {
    ...
    text:"The sales manager at Cloud Kicks wants a way to report on information from a form their clients fill out during the sales cycle. Once a form has been submitted, the client is unable to access it. This form may need to be filled out more than once during the sales cycle. There are more than 30 fields on this form, and the sales team needs to be able to see what changed from one submission to the next. Which two options should an administrator use to solve this scenario?",
    options:[
      {letter:"A", text:"Add forms as attachments."},
      {letter:"B", text:"Make custom fields."},
      {letter:"C", text:"Create a custom object."},
  ...
  },
  {
    ...
    text:"The administrator at Cloud Kicks needs to set up automation to update three fields on the Shipment custom object. Because of the effect these updates will have on some programmatic customizations, they need to happen in a very specific order. How should the administrator configure the field updates to ensure the proper order.",
    options:[
      {letter:"A", text:"Create three workflow rules in order, one workflow rule for each field update."},
      {letter:"B", text:"Create a process with one criteria node and three field updates in the correct order."},
      {letter:"C", text:"Create a process with three criteria nodes and stop after each action."},
  ...
  },
  {
    ...
    text:"A user accidentally created a duplicate opportunity and is unable to delete the duplicate record. What should an administrator do to troubleshoot this issue?",
    options:[
      {letter:"A", text:"Run a report of all opportunities to identify other possible duplicates."},
      {letter:"B", text:"Check the user profile permissions on the Opportunity object to see if they have permission to delete."},
      {letter:"C", text:"Advise the user to mark the duplicate opportunity Closed Lost and keep it in the system."},
  ...
  },
  {
    ...
    text:"AW Computing uses a custom Invoice object to track invoices related to accounts. The administrator wants to use roll-up summary fields to view high-level information at a glance on the account record. Which two considerations should an administrator remember about roll-up summary fields?",
    options:[
      {letter:"A", text:"Roll-up types include COUNT, SUM, and AVG."},
      {letter:"B", text:"Roll-up summary fields are created on the master side of a master-detail relationship."},
      {letter:"C", text:"Roll-up summary fields prevent the conversion of a master-detail relationship to a lookup."},
  ...
  },
  {
    ...
    text:"The administrator at Universal Containers recently rolled out Email-to-Case functionality. Even though a new record type was created and specified in the Email-to-Case settings, all incoming cases are receiving a different record type. What is likely causing the record type discrepancy?",
    options:[
      {letter:"A", text:"The new Case Owner needs permissions to the new record type."},
      {letter:"B", text:"The Automated Case User needs permissions to the new record type."},
      {letter:"C", text:"A Case assignment rule is preventing the record type from being updated."},
  ...
  },
  {
    ...
    text:"Management at Ursa Major Solar wants to understand how many accounts have opportunities in the overall pipeline. What should the administrator use to create a report showing all open opportunities and the total number of accounts represented?",
    options:[
      {letter:"A", text:"The row count on a summary report grouped by account name"},
      {letter:"B", text:"A Cross Filter selecting opportunities with accounts"},
      {letter:"C", text:"A custom report type showing opportunities with accounts"},
  ...
  },
  {
    ...
    text:"AW Computing created new multi-tier service plans. The primary difference between the packages Is the length of the term. The company wants to capture start and end dates for each service plan sold, which can differ from the contract dates of the subscription. How should an administrator ensure the data is captured properly?",
    options:[
      {letter:"A", text:"Build a validation rule on the Opportunity object to require custom date fields based on the product(s) selected."},
      {letter:"B", text:"Configure formula fields to reflect the close date of the opportunity."},
      {letter:"C", text:"Create a new price book for service plans with term lengths."},
  ...
  },
  {
    ...
    options:[
      {letter:"A", text:"Create a lookup-relationship on the Payment with a Roll-up Summary field on the Invoice."},
      {letter:"B", text:"Create a lookup-relationship on the Payment and a workflow cross object field update."},
      {letter:"C", text:"Create a master-detail relationship on the Payment and a workflow cross object field update."},
  ...
  },
  {
    ...
    text:"What would prevent a user from syncing a quote with an opportunity?",
    options:[
      {letter:"A", text:"The quote has a validation rule preventing it from being updated."},
      {letter:"B", text:"Another quote is already synced with the opportunity and is awaiting approval."},
      {letter:"C", text:"Another quote is already synced with the opportunity."},
  ...
  },
  {
    ...
    text:"Person accounts were recently activated at Cloud Kicks. There are three record types for accounts: • B2B customer • B2C Customer • External Partner There are two record types for leads: • B2B Lead • B2C Lead The test team finds that when the Convert button is clicked on a B2C Lead record, only the B2B Customer and External Partner account record types are available choices on the Conversion Layout. What should the administrator do to correct this issue?",
    options:[
      {letter:"A", text:"Hide the Record Type field on the Account section of the Conversion Layout."},
      {letter:"B", text:"Build a process that updates the record type field to B2C Customer after conversion."},
      {letter:"C", text:"Use a validation rule to ensure the company name on B2C Leads is blank."},
  ...
  },
  {
    ...
    text:"Sales reps at Ursa Major Solar often give discounts depending on the configuration of the solar panel system. Customers want to know what the different configuration options are. Sales management wants to ensure the opportunity pipeline is as accurate as possible. What should sales reps do to ensure their quotes and opportunities reflect their sales?",
    options:[
      {letter:"A", text:"Update the quote record each time the customer requests a different product configuration, and clicks the sync button to update the opportunity."},
      {letter:"B", text:"Create a new quote record for each of the different product configurations. Sync the most likely to be purchased back to the opportunity."},
      {letter:"C", text:"Create new opportunities for each quote request. Change the forecast category to omitted for all except the most likely to be purchased."},
  ...
  },
  {
    ...
    text:"A custom object called Item has a many-to-many relationship with the Account and Quota objects. At Cloud Kicks, account owners are changed frequently while ownership of Quota records remains unchanged. When an account owner is updated, the new account owner can only see Item records if they are also the owner of the Quota record. What step should the administrator take to give access to all Item records?",
    options:[
      {letter:"A", text:"Change the data format of the Quota relationship field from master-detail to lookup."},
      {letter:"B", text:"Re-assign the Quota master-detail to the primary and the Account master-detail to secondary."},
      {letter:"C", text:"Create a Quota criteria-based sharing rule using ISCHANGED for the Account Owner field."},
  ...
  },
  {
    ...
    text:"AW Computing has implemented the Contacts to Multiple Accounts functionality. Users should be able to distinguish between contacts and related contacts. What should the administrator do to configure the account page layout?",
    options:[
      {letter:"A", text:"Display both the contacts and the related contacts related lists."},
      {letter:"B", text:"Display the related accounts related list on the page layout."},
      {letter:"C", text:"Display the related contacts related list and add the direct field."},
  ...
  },
  {
    ...
    text:"Cloud Kicks (CK) typically sells Its products direct to consumer and tracks sales using the Order object In Salesforce. The head of sales has now decided that CK will also sell to retail locations for resale. The administrator wants to leverage opportunities and opportunity products for these new deals. What should the administrator do to track accurate sales data on opportunities?",
    options:[
      {letter:"A", text:"Create new Products with the new retail pricing."},
      {letter:"B", text:"Add a new Order Process for Orders generated from opportunities."},
      {letter:"C", text:"Create a new Price Book for the new retail pricing."},
  ...
  },
  {
    ...
    text:"AW Computing organizes Its sales regions as East, Central, and West. Each region has sales reps, a sales director, and sales operations members. The organization-wide default for all objects is set to Private. Members of the operations team for the East region need access to all the accounts and opportunities in the region. How should the administrator configure this requirement?",
    options:[
      {letter:"A", text:"Instruct the operations team members to add themselves to the account teams."},
      {letter:"B", text:"Create an Opportunity sharing rule with a public group containing the East operations profile."},
      {letter:"C", text:"Assign to a role in the role hierarchy positioned above the East sales director."},
  ...
  },
  {
    ...
    text:"Universal Containers has a Private sharing model for Accounts and Opportunities. A new team is being created from within the sales team that will be assigned all renewal opportunities. These users will need to see all closed won opportunities while keeping the account private. How should the administrator meet this requirement?",
    options:[
      {letter:"A", text:"Update the organization-wide default on Opportunities to Public Read Only and add them to the opportunities team."},
      {letter:"B", text:"Create a permission set with View All enabled on Accounts and assign it to the new users."},
      {letter:"C", text:"Create a new profile for the renewals team with View All permission enabled on Accounts and Opportunities."},
  ...
  },
  {
    ...
    text:"Users at Ursa Major Solar want to create complex dashboards with supporting charts based on data that comes from a variety of sources, some of which live on the Internal company shared drives. Which product should the administrator recommend to meet the users' needs?",
    options:[
  ...
  },
  {
    ...
    text:"The administrator at Cloud Kicks created a flow in a sandbox that walks service agents through the Return Merchandise Authorization creation process. The administrator deployed the flow to production with a Change Set. Users are unable to use the flow in production. Which step should the administrator take?",
    options:[
      {letter:"A", text:"Activate the flow manually after deployment."},
      {letter:"B", text:"Include the active and prior inactive flow version in the Change Set."},
      {letter:"C", text:"Ensure there is an active flow version in the sandbox."},
  ...
  },
  {
    ...
    text:"An administrator would like to know if any other administrators or delegated administrators are using the Log In As a User feature. Where should the administrator look to find this information?",
    options:[
      {letter:"A", text:"Grant Account Login Access"},
      {letter:"B", text:"Setup Audit Trail"},
      {letter:"C", text:"Connected App Usage"},
  ...
  },
  {
    ...
    text:"Cloud Kicks users need to link multiple Case records to multiple Outcome records stored in a custom object. Any user that can view the Case record must be able to create a link. The administrator creates a Case Outcome custom object. What is the recommended option to use when adding a field to Case Outcome?",
    options:[
      {letter:"A", text:"Lookup relationship with Read-Only sharing setting."},
      {letter:"B", text:"Master-detail relationship with Read-Only sharing setting."},
      {letter:"C", text:"Lookup relationship with Read/Write sharing setting"},
  ...
  },
  {
    ...
    text:"Ursa Major Solar (UMS) receives hundreds of cases every week from both consumers and retail partners. UMS wants to ensure it's meeting all service-level agreements to maintain high levels of customer satisfaction. What should the administrator do to help meet this goal?",
    options:[
      {letter:"A", text:"Set up and configure Entitlement Process to design timelines and track issue resolution."},
      {letter:"B", text:"Configure the Milestones object on Service Contracts to sequence milestones for common case issues."},
      {letter:"C", text:"Design a Net Promoter Score survey using Surveys that is automatically sent when a case is closed."},
  ...
  },
  {
    ...
    text:"As part of their yearly audit, the compliance team at Cloud Kicks would like to track when a user's profile has been changed and who changed the data. What should the administrator review to meet this requirement?",
    options:[
      {letter:"A", text:"Field History Tracking"},
      {letter:"B", text:"Setup Audit Trail"},
      {letter:"C", text:"Historical Trending"},
  ...
  },
  {
    ...
    text:"DreamHouse Realty wants better insights into potential revenue in the next quarter and is considering using Collaborative Forecasts. What should the administrator consider when setting up Collaborative Forecasts?",
    options:[
      {letter:"A", text:"Opportunity Split data cannot be viewed in a forecast."},
      {letter:"B", text:"A forecast can be either revenue-based or quantity-based."},
      {letter:"C", text:"A single org can have up to six different types of forecasts."},
  ...
  },
  {
    ...
    text:"Ursa Major Solar (UMS) wants to identify customers that need to install a new solar panel monitor system it recently released. UMS tracks the installed products as Asset records that are related to the Account. Sales management has asked the administrator to create a report for users. What is the recommended method for the administrator to meet the requirement?",
    options:[
      {letter:"A", text:"Use PREVGROUPVAL() in Report Builder."},
      {letter:"B", text:"Use Role Hierarchy filter to restrict related records."},
      {letter:"C", text:"Use a Summary report with Bucket Columns."},
  ...
  },
  {
    ...
    text:"Cloud Kicks (CK) is working on adding a Knowledge base to its online customer community. The administrator suggests using Salesforce Knowledge to meet this requirement. What are three reasons CK should utilize Data Categories when creating articles in Knowledge? Choose 3 answers",
    options:[
      {letter:"A", text:"Up to five Data Category groups can be created for segmentation."},
      {letter:"B", text:"Data Categories help organize the Knowledge base content displayed."},
      {letter:"C", text:"Every article is required to have a Data Category for sorting."},
      {letter:"D", text:"Data Categories provide a way to secure access to the Knowledge base content."},
  ...
  },
  {
    ...
    text:"Ursa Major Solar wants to add a chat component to its corporate website, where its service agents can respond directly from Salesforce. What are two considerations the administrator should understand before adding Chat to the Service Console?",
    options:[
      {letter:"A", text:"Chat is unavailable in Lightning Experience if also using Omni-Channel."},
      {letter:"B", text:"Chat can only be added to Standard navigation Lightning apps."},
      {letter:"C", text:"Chat must be routed with Omni-Channel in Lightning Experience."},
  ...
  },
  {
    ...
    text:"Cloud Kicks has an export of Order and Order Item data from an enterprise resource planning (ERP) system. The data must be imported into the Salesforce Order and Order Product objects, while maintaining the relationships in the data. What are two ways the administrator should load the data?",
    options:[
      {letter:"A", text:"Use an Upsert operation to load data."},
      {letter:"B", text:"Use an Insert operation to load data."},
      {letter:"C", text:"Replace the Salesforce record ID with the External ID."},
  ...
  },
  {
    ...
    text:"An administrator is building a report for a real estate company and needs to filter results effectively. Which three fields should be used as filter criteria? Choose 3 answers",
    options:[
      {letter:"A", text:"A phone field that provides the full phone number of the seller."},
      {letter:"B", text:"A multi-select picklist field that designates features of the listing."},
      {letter:"C", text:"A number field that designates the square footage of the listing."},
      {letter:"D", text:"A formula field that calculates a price for the listing."},
  ...
  },
  {
    ...
    text:"AW Computing continues to grow and has concerns about the volume of sensitive data being stored in its org. The administrator suggests utilizing Salesforce Shield. What should the team consider before Implementing Salesforce Shield?",
    options:[
      {letter:"A", text:"Encrypted fields are unable to be referenced in flows."},
      {letter:"B", text:"Einstein Lead Scoring is available on encrypted fields."},
      {letter:"C", text:"Paused flows can cause data to be saved in an unencrypted state."},
  ...
  },
  {
    ...
    text:"The Cloud Kicks security team has seen an increase in unattended device attacks, where hackers can view sensitive information when users leave devices unlocked in public settings. The security team wants to ensure Salesforce data cannot be viewed after 10 minutes of inactivity. What is the recommended security setting to configure?",
    options:[
      {letter:"A", text:"Enforce login IP ranges on every request."},
      {letter:"B", text:"Lock sessions to the domain in which they were first used."},
      {letter:"C", text:"Require a high assurance session."},
  ...
  },
  {
    ...
    text:"When an Account has more than five open opportunities over US$10,000, the sales rep should have an option on the Account page to start the escalation process to allocate additional resources. Which two configurations should the administrator create?",
    options:[
      {letter:"A", text:"Component Visibility filter"},
  ...
  },
  {
    ...
    text:"Cloud Kicks uses a dashboard with multiple components based on Account, Case, and Opportunity reports. The system administrator adds a dashboard filter on Account Owner. When filtering the dashboard by Account Owner, records are now missing from several Opportunity components. What is the recommended way for the system administrator to resolve this issue?",
    options:[
      {letter:"A", text:"Add a cross-filter to the Opportunity source reports."},
      {letter:"B", text:"Use a custom report type for Accounts with or without Opportunities."},
      {letter:"C", text:"On the Opportunity components, change the equivalent field."},
  ...
  },
  {
    ...
    text:"Cloud Kicks users report receiving an \"Apex CPU time limit exceeded\" error message when attempting to close certain opportunity records. This does not occur on every opportunity record change or for every user. What is the recommended method for the administrator to identify the cause?",
    options:[
      {letter:"A", text:"Monitor with Login Forensics."},
      {letter:"B", text:"Enable Debug Logging for users."},
      {letter:"C", text:"Review the Setup Audit Trail."},
  ...
  },
  {
    ...
    text:"Cloud Kicks would like to reassign ownership of all leads that are open and more than 60 days old. The system administrator has written an assignment rule to distribute these leads to the correct owners or queues. Which two tools should the administrator use to update the owner of these leads?",
    options:[
      {letter:"A", text:"Bulk API"},
      {letter:"B", text:"Mass Update"},
  ...
  },
  {
    ...
    text:"Cloud Kicks needs to create 10 separate environments for various projects. A developer sandbox has been created with the necessary configuration and data. The administrator needs to create 10 new environments with the same metadata and data for each user. What should the administrator do to meet the requirements?",
    options:[
      {letter:"A", text:"Use refresh sandbox without Auto Activate."},
      {letter:"B", text:"Use the existing sandbox as a sandbox template."},
      {letter:"C", text:"Use clone a sandbox option from the existing sandbox."},
  ...
  },
  {
    ...
    text:"Cloud Kicks (CK) has introduced its new Alpha Shoe line. Customers create cases from CK's website. Managers receive a report of all cases created last week. Managers would like a way to easily see in the report if the customer refers to the new shoe line in the case subject. How should the system administrator modify the report to meet this request?",
    options:[
      {letter:"A", text:"Add a cross-filter and a 'with' sub-filter."},
      {letter:"B", text:"Build a row-level formula."},
      {letter:"C", text:"Change the format to a joined report."},
  ...
  },
  {
    ...
    text:"An administrator wants to determine if brute-force password attacks are being used against the org. A brute-force attack is when multiple password combinations are attempted in a short time period. Where should the administrator look for more information?",
    options:[
      {letter:"A", text:"Login Forensics"},
      {letter:"B", text:"Connected Apps OAuth Usage"},
      {letter:"C", text:"Event Manager"},
  ...
  },
  {
    ...
    text:"Ursa Major Solar allows accounts to apply for loans to purchase solar panels. Financial information will be stored in a custom object. Only finance team members should see the related financial information about the account. What kind of field should the administrator create in the custom object?",
    options:[
      {letter:"A", text:"Lookup Relationship"},
      {letter:"B", text:"External Relationship"},
  ...
  },
  {
    ...
    text:"Cloud Kicks needs to track government-issued identification numbers for its customers. The security team requires that the identification number cannot be changed by users and must be masked when displayed, except the last two digits. Which two recommended configurations should the administrator create?",
    options:[
      {letter:"A", text:"Use a field with Classic Encryption."},
      {letter:"B", text:"Enable Shield Platform Encryption."},
      {letter:"C", text:"Configure a Field Encryption Policy"},
  ...
  },
  {
    ...
    text:"On the Contact record, if a contact has the value of 'CEO‘ in the Title field, the administrator wants to require the users to also put a phone number in the Phone field. What formula should the administrator put in the Error Condition Formula of a validation rule to enable this?",
    options:[
      {letter:"A", text:"Title = 'CEO' && NOT(ISBLANK(Phone))"},
      {letter:"B", text:"Title <> 'CEO' && NOT(ISBLANK(Phone))"},
      {letter:"C", text:"Title = 'CEO' && ISBLANK(Phone)"},
  ...
  },
  {
    ...
    options:[
      {letter:"A", text:"Share with roles and subordinates of the finance director role."},
      {letter:"B", text:"Make an owner-based sharing rule where the Won field = true."},
      {letter:"C", text:"Create a criteria-based sharing rule where the won field = true."},
  ...
  },
  {
    ...
    text:"A user at Universal Containers wants to load records Into a custom object named Location from a .csv file. While using Data Loader, they cannot find the Location object. What are two reasons this is happening?",
    options:[
      {letter:"A", text:"The label of Location may have been changed."},
      {letter:"B", text:"Data Loader should only be used with standard objects."},
      {letter:"C", text:"Location has a master-detail field to Account."},
  ...
  },
  {
    ...
    text:"The sales department has asked to limit access to the Amount field on the Opportunity to only those users in the sales department and on the executive team, Northern Trail Outfitters uses six custom profiles including Sales User, Marketing User, Call Center User, Executive User, Sales Manager User, and Call Center Manager User. Field level access is removed from three of the profiles in the sandbox. What action should an administrator take to make sure this change is in production?",
    options:[
      {letter:"A", text:"Create a sandbox template and push it to production to reflect the update."},
      {letter:"B", text:"Manually restrict access to this field for each profile via Setup Just like the sandbox."},
      {letter:"C", text:"Deploy a change set from the sandbox to production including the Amount field with all the custom profiles."},
  ...
  },
  {
    ...
    text:"The administrator at Cloud Kicks noticed that a before trigger, which handles saving the original version of a record to an external database, fails. However, a flow configured for fast field updates runs successfully. How should the administrator advise the developer?",
    options:[
      {letter:"A", text:"Record-triggered flows that are configured to run before save execute prior to all before triggers."},
      {letter:"B", text:"A validation rule could be preventing records from ever meeting the conditions in the trigger."},
      {letter:"C", text:"The trigger is writing the data to the wrong place in the external data archive."},
  ...
  },
  {
    ...
    text:"Cloud Kicks (CK) has an email parsing tool. CK wants to ensure that when certain fields are updated, the Case Owner is notified by email. What should the administrator use to email the Case Owner?",
    options:[
      {letter:"A", text:"Email-to-Case"},
      {letter:"B", text:"Outbound Message"},
      {letter:"C", text:"Before Save Flow"},
  ...
  },
  {
    ...
    text:"AW Computers has created a custom field called Government ID on a custom object. Most users with a custom Sales profile should be unable to access this field. A select group of Sales users called the Institutional Team should be able to access the Government ID field via reports. How should an administrator accommodate this request?",
    options:[
      {letter:"A", text:"Create a permission set with Read access to the field. Assign the permission set to the Institutional Team."},
      {letter:"B", text:"Configure a report type with the Government ID field. Assign this report type to the Institutional Team via a permission set."},
      {letter:"C", text:"Mark the field as Read Only on the sales profile. Create a permission set to re-enable reporting for the Institution Team."},
  ...
  },
  {
    ...
    text:"An administrator at Cloud Kicks has built a flow that delivers status update email to customers. Recently, there’s been an increase in support cases from customers reporting they had not received the email. Where should the administrator look to investigate the issue?",
    options:[
      {letter:"A", text:"Paused Flow Interviews"},
      {letter:"B", text:"Process Automation Setting"},
      {letter:"C", text:"Email Logs"},
      {letter:"D", text:"Setup Audit Trail"}
    ],
    answer:["C"], multi:false,
  ...
  },
  {
    ...
    text:"A request was made to import a spreadsheet of new Campaign Members. The system administrator started Data import Wizard but the Campaign Members object was unavailable as a choice. What is causing this to occur?",
    options:[
      {letter:"A", text:"The Salesforce Id field is required and was missing from the file."},
      {letter:"B", text:"The marketing user feature license assignment is missing on the admin’s user record."},
      {letter:"C", text:"Import Wizard is only available for the Standard objects Accounts, Contacts, and Leads."},
  ...
  },
  {
    ...
    text:"AW Computing tracks the computer equipment in each of its conference rooms with a custom object called Equipment, which has a master-detail relationship to another custom object called Room. Management wants to see the total number of Equipment records related to each Room record. How should an administrator accomplish this?",
    options:[
      {letter:"A", text:"Make record-triggered flows whenever Equipment records are created, modified or deleted."},
      {letter:"B", text:"Write record-triggered flows whenever Room records are related, modified, or deleted."},
      {letter:"C", text:"Configure a roll-up summary field on Equipment."},
  ...
  },
  {
    ...
    text:"Cloud Kicks uses a Review junction object to track product reviews by account. the Review object has a Master-Detail relationship to Account and a Master-Detail relationship to a customer Product object. A user accidentally deleted the Account, Product, and related Review records. How should the deleted Review records be restored?",
    options:[
      {letter:"A", text:"Restore both the Account and Product master records from the Recycle Bin."},
      {letter:"B", text:"Restore the Review junction object record from the Recycle Bin."},
      {letter:"C", text:"Restore either the Account or Product master records from the Recycle Bin."},
  ...
  },
  {
    ...
    text:"A sales rep at Ursa Major Solar realized that the wrong price book was selected for an opportunity. How can the sales rep change the price book on the opportunity?",
    options:[
      {letter:"A", text:"Once selected, the price book can be updated via the forecasts tab."},
      {letter:"B", text:"Once selected, the price book is locked on the opportunity."},
      {letter:"C", text:"The change can be made through the desktop site."},
  ...
  },
  {
    ...
    text:"Northern Trail Outfitters (NTO) wants to change the current master-detail relationship between Shipments and Opportunity to a lookup relationship. The system administrator has made the necessary changes in a full sandbox and has successfully tested them against NTO’s data. Now that the changes are ready to implement in production, what should the system administrator do next?",
    options:[
      {letter:"A", text:"Make the changes directly in the production org."},
      {letter:"B", text:"Create an Unmanaged Package to distribute to production."},
      {letter:"C", text:"Use Data Loader to export the changes to the production org."},
  ...
  },
  {
    ...
    text:"Cloud Kicks uses a Lightning web component to provide instructions to sales reps. An administrator needs to correct a spelling error in the displayed text in one of the Lightning web components. What is the recommended tool to make the change?",
    options:[
      {letter:"A", text:"Developer Org"},
      {letter:"B", text:"VisualStudio Code"},
      {letter:"C", text:"Salesforce Lightning Inspector"},
  ...
  },
  {
    ...
    text:"The sales manager at Cloud Kicks (CK) wants to make sure the accounts that CK serves are happy. One way they track this is by how many open cases an account has with CK. The sales manager asks CK's administrator to build a report to show Accounts with Open Cases. What report type would this be?",
    options:[
      {letter:"A", text:"Bucket Report"},
      {letter:"B", text:"Joined Report"},
      {letter:"C", text:"Summary Report"},
      {letter:"D", text:"Matrix Report"}
    ],
    answer:["C"], multi:false,
  ...
  },
  {
    ...
    text:"Sales management wants a small subset of users with different profiles and roles to be able to view all data for compliance purposes. How can an administrator meet this requirement?",
    options:[
      {letter:"A", text:"Assign delegated administrator to the subset of users to View All Data."},
      {letter:"B", text:"Create a new profile and role for the subset of users with the View All Data permission."},
      {letter:"C", text:"Enable the View All Data permission for the roles of the subset of users."},
  ...
  },
  {
    ...
    text:"AW Computing is looking to enhance Salesforce to track conference rooms and IT equipment. An administrator has created a custom object called Room. The administrator also created a custom object called Equipment. This object has two fields: a currency field Price, and a lookup relationship to Room. While performing user acceptance testing, management requested to roll up all the Price values and display them on the corresponding Room record. How should an administrator accomplish this?",
    options:[
      {letter:"A", text:"Write record-triggered flows whenever Room records are created, modified, or deleted."},
      {letter:"B", text:"Make record-triggered flows whenever Equipment records are created, modified, or deleted."},
      {letter:"C", text:"Create a roll-up summary field on Room."},
  ...
  },
  {
    ...
    options:[
      {letter:"A", text:"The trigger is writing the data to the wrong place in the external data archive."},
      {letter:"B", text:"The code could be trying to create duplicates in the archive when it is unable to."},
      {letter:"C", text:"Record-triggered flows that are configured to run before save execute prior to all before triggers."},
...
// The embedded bank above is the built-in PLAT-ADMN-301 exam and the file://
// fallback. Capture it before `QUESTIONS` is reassigned to a fetched bank.
const EMBEDDED_QUESTIONS = QUESTIONS;
...
const state = {
  ...
  timerInterval: null,
  timerSeconds: exam.examMinutes * 60,
  examSubmitted: false
};

// ---------- Category-to-Tab mapping (rebuilt per exam by configureExam) ----------
// Tab 0 = Dashboard, tabs 1..N = one per category, last tab = Full Exam.
...
function deriveCategories(bank) {
  const seen = [];
  bank.forEach(q => { if (q.category && !seen.includes(q.category)) seen.push(q.category); });
  return seen;
}

function configureExam(cfg, bank) {
  exam = cfg;
  QUESTIONS = Array.isArray(bank) ? bank : [];
...
// ---------- Session Persistence ----------
// Study-mode progress is saved to localStorage so it survives a page reload.
// Exam mode is a fresh timed run and is intentionally NOT persisted.
const sessionKey = () => `sc_session_${exam.id}`;
...
function loadSession() {
  // Always start from a clean slate so a stale in-memory state never leaks in
  state.answers = {};
  state.submitted = {};
  try {
    ...
    // Keep only answers for questions that still exist in the current bank
    const validIds = new Set(QUESTIONS.map(q => String(q.id)));
    Object.keys(data.answers || {}).forEach(qid => {
      if (validIds.has(String(qid))) state.answers[qid] = data.answers[qid];
    });
    Object.keys(data.submitted || {}).forEach(qid => {
      if (validIds.has(String(qid))) state.submitted[qid] = data.submitted[qid];
    });
    return true;
  } catch (e) {
    return false;
...
function updateSessionStatus() {
  ...
  if (state.mode === "study" && answered > 0) {
    el.textContent = `💾 ${answered} saved`;
    if (resetBtn) resetBtn.disabled = false;
  } else {
    el.textContent = "";
    if (resetBtn) resetBtn.disabled = state.mode !== "study";
  }
}

window.resetSession = function() {
  if (!confirm("Reset your saved study progress? This clears all your answers and cannot be undone.")) return;
  clearSession();
  state.answers = {};
  state.submitted = {};
  if (state.mode === "exam") {
    ...
    toggleMode(false); // returns to a clean study view
  } else {
    renderAllQuizTabs();
    updateScoreMatrix();
    setActiveTab(0);
...
const flagsKey = () => `sc_flags_${exam.id}`;
...
function saveFlags() {
  try {
    localStorage.setItem(flagsKey(), JSON.stringify(Object.keys(state.flagged).map(Number)));
  } catch (e) {
    // ignore
  }
}
...
// ---------- Knockout session recovery ----------
// A Knockout run is saved to localStorage after every answer so an accidental
// reload or tab close can be resumed. (Endless is not saved — it has no end
// state to recover.) The session is cleared only when the pool is fully cleared
// or the user explicitly starts over.
const knockoutKey = () => `sc_knockout_${exam.id}`;

function saveKnockout() {
  if (rapid.mode !== "knockout" || !rapid.active || rapid.done) return;
  if (!rapid.remaining || rapid.remaining.size === 0) { clearKnockout(); return; }
  try {
    localStorage.setItem(knockoutKey(), JSON.stringify({
      version: 1,
      remaining: Array.from(rapid.remaining),
      seen: rapid.seen,
      correct: rapid.correct,
      mastered: rapid.mastered,
      streak: rapid.streak,
      bestStreak: rapid.bestStreak,
      savedAt: Date.now()
    }));
  } catch (e) {
    // storage unavailable — recovery just won't be offered
  }
  updateRapidResumeHint();
}

function loadKnockout() {
  try {
    const raw = localStorage.getItem(knockoutKey());
    if (!raw) return null;
    const d = JSON.parse(raw);
    if (!d || !Array.isArray(d.remaining)) return null;
    // Keep only ids still present in the current bank (it may have changed/switched)
    const valid = new Set(QUESTIONS.map(q => q.id));
    const remaining = new Set(d.remaining.filter(id => valid.has(id)));
    if (remaining.size === 0) return null; // nothing left to resume / stale
    return {
      remaining,
      seen: d.seen | 0,
      correct: d.correct | 0,
...
function clearKnockout() {
  try {
    localStorage.removeItem(knockoutKey());
  } catch (e) {
    // ignore
  }
  updateRapidResumeHint();
...
function hasKnockout() {
  return loadKnockout() !== null;
}

// Small pulsing dot on the ⚡ Rapid Fire button when a session can be resumed
function updateRapidResumeHint() {
  const btn = $("#btn-rapid-launch");
  if (btn) btn.classList.toggle("has-resume", hasKnockout());
}

window.resumeKnockout = function() {
  const saved = loadKnockout();
  if (!saved) { rapidRenderPicker(); return; }
  rapid.active = true;
  rapid.mode = "knockout";
  rapid.pool = QUESTIONS;
  rapid.remaining = saved.remaining;
  rapid.seen = saved.seen;
  rapid.correct = saved.correct;
  rapid.mastered = saved.mastered;
  rapid.streak = saved.streak;
  rapid.bestStreak = saved.bestStreak;
  rapid.done = false;
  rapidRefillQueue();
  rapidRender();
};
...
window.beginRapid = function(mode) {
  // Starting a fresh Knockout would discard a saved one — confirm, or resume it
  if (mode === "knockout" && hasKnockout()) {
    if (!confirm("You have a Knockout session in progress. Start over and discard it?")) {
      resumeKnockout();
      return;
    }
    clearKnockout();
...
function rapidRenderPicker() {
  ...
  const resumeCard = saved ? `
    <button type="button" class="rapid-resume-card" onclick="resumeKnockout()">
      <span class="rrc-icon">↩️</span>
      <span class="rrc-text">
        <strong>Resume Knockout</strong>
        <span>Continue your saved session — ${saved.mastered} mastered, ${saved.remaining.size} to go.</span>
      </span>
    </button>` : "";
  body.innerHTML = `
...
function rapidRenderDone() {
  ...
  if (!body) return;
  rapid.done = true;
  clearKnockout(); // session finished — nothing left to recover
  const acc = rapid.seen ? Math.round((rapid.correct / rapid.seen) * 100) : 0;
  body.innerHTML = `
...
window.rapidReveal = function() {
  ...
  saveKnockout(); // persist knockout progress after every answer (no-op in endless)
};
...
// The full bank (questions, answers, explanations, hooks) lives in questions.json
// so it can be swapped without editing app.js. When the app is served over HTTP,
// this is fetched at startup and replaces the embedded fallback bank above. When
// opened from file:// (no fetch), the embedded bank is used instead.
...
// Fetch a given exam's bank JSON. Returns the array, or null (file:// / offline /
// invalid), in which case the caller uses a fallback bank.
async function loadBank(cfg) {
  try {
    const res = await fetch(cfg.bank, { cache: "no-store" });
    if (!res.ok) return null;
    const data = await res.json();
    if (!isValidBank(data)) {
      console.warn(`${cfg.bank} failed validation — using a fallback bank.`);
      return null;
    }
    return data;
  } catch (e) {
...
// Optional exams.json manifest overrides the embedded registry when reachable.
async function loadRegistry() {
  try {
    const res = await fetch("exams.json", { cache: "no-store" });
    if (!res.ok) return;
    const data = await res.json();
    const list = Array.isArray(data) ? data : (data && data.exams);
    if (Array.isArray(list) && list.length &&
        list.every(e => e && typeof e.id === "string" && typeof e.bank === "string")) {
      examRegistry = list;
    }
  } catch (e) {
    // keep the embedded registry
  }
}

const ACTIVE_EXAM_KEY = "sc_active_exam";
function getActiveExamCfg() {
  let id;
  try { id = localStorage.getItem(ACTIVE_EXAM_KEY); } catch (e) { id = null; }
  return examRegistry.find(e => e.id === id) || examRegistry[0];
}
function setActiveExam(id) {
  try { localStorage.setItem(ACTIVE_EXAM_KEY, id); } catch (e) { /* ignore */ }
}

// Resolve a config's bank, falling back to the embedded default bank on file://.
async function resolveBank(cfg) {
  const embedded = EMBEDDED_QUESTIONS; // built-in PLAT-ADMN-301 bank
  const fetched = await loadBank(cfg);
  if (fetched) return { cfg, bank: fetched };
  if (cfg.id === DEFAULT_EXAM_ID) return { cfg, bank: embedded };
  // A non-default bank couldn't be loaded (e.g. file://) — fall back to default
  const def = examRegistry.find(e => e.id === DEFAULT_EXAM_ID) || examRegistry[0];
  const defFetched = def.id === DEFAULT_EXAM_ID ? embedded : (await loadBank(def) || embedded);
  setActiveExam(def.id);
  return { cfg: def, bank: defFetched };
}

// ---------- Tab panes (generated to match the current exam's tab count) ----------
function ensureTabPanes() {
  const content = $(".tab-content");
  if (!content) return;
  content.innerHTML = "";
  for (let i = 0; i <= FULL_EXAM_TAB; i++) {
    const pane = document.createElement("div");
    pane.className = "tab-pane" + (i === state.activeTab ? " active" : "");
    pane.id = `tab-${i}`;
...
// ---------- Astro mascot (inline SVG homage to Salesforce's Astro) ----------
const ASTRO_SVG = `
<svg class="astro-mascot" viewBox="0 0 240 240" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Astro mascot">
  <ellipse cx="120" cy="214" rx="66" ry="24" fill="#1a76d2"/>
  <path d="M60 168 q-6 34 24 44 h72 q30 -10 24 -44 z" fill="#2a93e0"/>
  <ellipse cx="120" cy="138" rx="70" ry="66" fill="#F3D2A2"/>
  <ellipse cx="120" cy="150" rx="42" ry="34" fill="#FBE7C6"/>
  <!-- coonskin tail -->
  <path d="M186 92 q46 8 44 66 q-2 34 -30 40 q22 -30 4 -58 q-14 -22 -40 -34 z" fill="#5b3a22"/>
  <path d="M198 118 q22 6 26 30" stroke="#8a5a34" stroke-width="9" fill="none" stroke-linecap="round"/>
  <path d="M206 150 q14 6 16 26" stroke="#8a5a34" stroke-width="9" fill="none" stroke-linecap="round"/>
  <!-- fur cap -->
  <path d="M46 104 Q120 8 194 104 Q158 84 120 84 Q82 84 46 104 Z" fill="#6b4429"/>
  <ellipse cx="120" cy="96" rx="82" ry="30" fill="#7d5233"/>
  <ellipse cx="120" cy="92" rx="82" ry="18" fill="#8a5a34"/>
  <!-- eyes -->
  <circle cx="97" cy="138" r="15" fill="#2b2b2b"/>
  <circle cx="143" cy="138" r="15" fill="#2b2b2b"/>
  <circle cx="102" cy="133" r="5" fill="#fff"/>
  <circle cx="148" cy="133" r="5" fill="#fff"/>
  <!-- nose + smile -->
  <path d="M113 156 h14 l-7 9 z" fill="#3a2a1e"/>
  <path d="M102 170 q18 16 36 0" stroke="#3a2a1e" stroke-width="4" fill="none" stroke-linecap="round"/>
  <!-- cheeks -->
  <circle cx="80" cy="160" r="9" fill="var(--sf-green-light)" opacity=".55"/>
  <circle cx="160" cy="160" r="9" fill="var(--sf-green-light)" opacity=".55"/>
</svg>`;

// To use Salesforce's official Astro artwork instead of the inline SVG homage,
// drop the image next to index.html (e.g. "astro.png") and set ASTRO_IMG to its
// path/URL. It renders as an <img> and falls back to the SVG if it fails to load.
const ASTRO_IMG = "assets/astro-web.png";
function mascotHTML() {
  return ASTRO_IMG
    ? `<img class="astro-mascot" src="${ASTRO_IMG}" alt="Astro" onerror="this.replaceWith(document.createRange().createContextualFragment(window.ASTRO_SVG))">`
    : ASTRO_SVG;
}
window.ASTRO_SVG = ASTRO_SVG;

// ---------- Home screen (Study Center) ----------
function updateExamBranding() {
  const h1 = $(".header-brand h1");
  if (h1) h1.innerHTML = `Astro Simulator<span>${exam.name}${exam.code ? ` · ${exam.code}` : ""}</span>`;
  const logo = $(".header-brand .logo-icon");
  if (logo) logo.innerHTML = mascotHTML();
}

function hasSavedSession(id) {
  try {
    const raw = localStorage.getItem(`sc_session_${id}`);
    if (!raw) return false;
    const d = JSON.parse(raw);
    return d && d.submitted && Object.keys(d.submitted).length > 0;
  } catch (e) {
    return false;
  }
}
...
function renderHome() {
  const hero = $("#home-mascot");
  if (hero) hero.innerHTML = mascotHTML();

  const statsEl = $("#home-stats");
  if (statsEl) {
    const nExams = examRegistry.length;
    const nQuestions = examRegistry.reduce((sum, e) =>
      sum + (e.id === DEFAULT_EXAM_ID ? EMBEDDED_QUESTIONS.length : (e.count || 0)), 0);
    statsEl.innerHTML =
      `<span class="home-stat">📚 ${nExams} exam${nExams === 1 ? "" : "s"}</span>` +
      (nQuestions ? `<span class="home-stat">🎯 ${nQuestions} questions to master</span>` : "");
  }

  const grid = $("#home-tiles");
  if (!grid) return;
  grid.innerHTML = examRegistry.map(e => {
    const count = e.id === DEFAULT_EXAM_ID ? EMBEDDED_QUESTIONS.length : (e.count || null);
    const cats = (e.categories && e.categories.length) || null;
    const resume = hasSavedSession(e.id);
    return `
      <button type="button" class="exam-tile" onclick="enterExam('${e.id}')">
        <div class="tile-mascot">${mascotHTML()}</div>
        <div class="tile-body">
          ${e.code ? `<div class="tile-code">${e.code}</div>` : ""}
          <div class="tile-name">${e.name}</div>
          <div class="tile-meta">
            ${count ? `<span>📚 ${count} questions</span>` : ""}
            ${cats ? `<span>🗂️ ${cats} domains</span>` : ""}
            ${e.passingScore ? `<span>🎯 ${e.passingScore}% to pass</span>` : ""}
          </div>
        </div>
        <span class="tile-cta">${resume ? "Continue →" : "Start studying →"}</span>
      </button>
    `;
  }).join("");
}
...
window.showHome = function() {
  if (rapid.active) exitRapid();
  renderHome();
  document.body.classList.remove("in-exam");
  window.scrollTo({ top: 0 });
};

window.enterExam = async function(id) {
  const cfg = examRegistry.find(e => e.id === id);
  if (!cfg) return;

  // Reset any timed exam / rapid session state before entering
  if (rapid.active) exitRapid();
  stopTimer();
  const timer = $(".exam-timer"); if (timer) timer.classList.remove("visible");
  const submitExamBtn = $(".submit-exam-btn"); if (submitExamBtn) submitExamBtn.classList.remove("visible");
  const modeToggle = $("#mode-toggle"); if (modeToggle) modeToggle.checked = false;
  state.mode = "study";
  state.examSubmitted = false;

  const resolved = await resolveBank(cfg);
  setActiveExam(resolved.cfg.id);
  configureExam(resolved.cfg, resolved.bank);
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  bindEvents();
  renderHome();
  showHome(); // land on the Study Center home; pick an exam tile to enter
});
...
function renderTabButtons() {
  const nav = $(".tab-nav");
  nav.innerHTML = "";
  // Dashboard, one tab per category, then Full Exam — built from the exam config
  const tabs = [{ label: "Dashboard", icon: "📊" }];
  CATEGORY_LIST.forEach(cat => tabs.push({ label: cat }));
  tabs.push({ label: `Full Exam (${QUESTIONS.length})`, icon: "🎯" });
  ...
  tabs.forEach((tab, i) => {
    ...
    btn.innerHTML = `${tab.icon || ""}${tab.label}${countBadge}`;
    nav.appendChild(btn);
  });
}
...
function setActiveTab(index) {
  ...
  $$(".tab-pane").forEach((pane) => {
    const paneIndex = parseInt(pane.id.replace("tab-", ""), 10);
...
function renderDashboard() {
  ...
  pane.innerHTML = `
    <div class="dashboard-grid">
      <div class="dash-card">
        <h2>📋 Exam Overview</h2>
        <p>${exam.name}${exam.code ? ` · ${exam.code}` : ""}</p>
        <div class="stat-row">
          <div class="stat-box">
          ...
          <div class="stat-box">
            <div class="stat-value">${exam.examMinutes}</div>
            <div class="stat-label">Minutes</div>
          </div>
          <div class="stat-box">
            <div class="stat-value">${exam.passingScore}%</div>
            <div class="stat-label">Passing Score</div>
          </div>
        </div>
        <p style="font-size:.8rem;color:var(--text-muted);">Multiple-choice and multi-select format. Question bank generated from datasets/ — run tools/parse_datasets.py after adding new source files. Answer keys and explanations audited against Salesforce documentation.</p>
      </div>
      ...
      <div class="dash-card full-width">
        ...
        <p>Check off domains as you study to track your coverage.</p>
...
function renderAllQuizTabs() {
  ...
  renderQuizTab(FULL_EXAM_TAB, "Full Exam Simulator", shuffled);
}

function getTabQuestions(tabIndex) {
  if (tabIndex === FULL_EXAM_TAB) {
    return [...QUESTIONS];
  }
...
// The options keep their original `letter` (the identity used for scoring and
// saved answers); only their display position — and thus the positional A/B/C/D
// badge — changes, so the correct answer no longer sits in a fixed spot.
function withShuffledOptions(q) {
  return { ...q, options: shuffleArray([...q.options]) };
}

window.shuffleTab = function(tabIndex) {
  const title = tabIndex === FULL_EXAM_TAB
    ? "Full Exam Simulator"
    : TAB_CATEGORIES[tabIndex];
  const questions = getTabQuestions(tabIndex).map(withShuffledOptions);
  const shuffled = shuffleArray(questions);
...
function restoreSubmittedState(tabIndex) {
  ...
  cards.forEach(card => {
    ...
    // Not yet submitted: restore any in-progress selection and enable submit
    if (!state.submitted[qid]) {
    ...
    const isCorrect = arraysEqual(userAnswers.slice().sort(), q.answer.slice().sort());
...
function updateScoreMatrix() {
  ...
  const passing = parseFloat(score) >= exam.passingScore;
  ...
  if (progressPill) progressPill.querySelector(".pill-value").textContent = `${totalAnswered}/${QUESTIONS.length}`;
...
function updateTabProgress() {
  ...
  const elFull = $(`#progress-${FULL_EXAM_TAB}`);
  if (elFull) elFull.textContent = `${allAnswered} / ${QUESTIONS.length} Answered`;
}
...
function toggleMode(isExam) {
  ...
  if (isExam) {
    // Start a fresh timed exam; the saved study session in localStorage is left intact.
    state.answers = {};
    state.submitted = {};
    state.examSubmitted = false;
    state.timerSeconds = exam.examMinutes * 60;
    ...
    setActiveTab(FULL_EXAM_TAB);
  } else {
    // Back to study mode: restore the saved study session (if any)
    loadSession();
...
function submitExam() {
  ...
  QUESTIONS.forEach(q => {
    if (!sectionResults[q.category]) sectionResults[q.category] = { total: 0, correct: 0 };
  ...
  const totalAnswered = Object.keys(state.submitted).length;
  const score = QUESTIONS.length > 0 ? ((totalCorrect / QUESTIONS.length) * 100).toFixed(1) : "0.0";
  const passed = parseFloat(score) >= exam.passingScore;
...
function showResultsModal(answered, correct, score, passed, sections) {
  ...
  modal.innerHTML = `
    ...
    <p class="result-subtitle">${passed ? "You passed the practice exam!" : `You didn't reach the ${exam.passingScore}% passing threshold.`}</p>
    ...
    <div class="results-breakdown">
      <div class="result-stat ${passed ? 'pass' : 'fail'}">
        <div class="rs-value">${correct}/${QUESTIONS.length}</div>
      ...
      <div class="result-stat">
        <div class="rs-value">${QUESTIONS.length - answered}</div>
        <div class="rs-label">Unanswered</div>
      </div>
      <div class="result-stat ${passed ? 'pass' : 'fail'}">
        <div class="rs-value">${passed ? "PASS" : "FAIL"}</div>
        <div class="rs-label">Status (≥${exam.passingScore}%)</div>
      </div>
    </div>
    ...
    <table class="results-section-table">
      ...
      <tbody>
        ${Object.entries(sections).filter(([, data]) => data.total > 0).map(([name, data]) => {
          const pct = data.total > 0 ? ((data.correct / data.total) * 100).toFixed(0) : 0;
          return `<tr>
            <td>${name}</td>
            <td>${data.correct}/${data.total} (${pct}%)</td>
            <td style="color:${pct >= exam.passingScore ? 'var(--color-correct)' : 'var(--color-incorrect)'}">${pct >= exam.passingScore ? "✓ Pass" : "✕ Needs Work"}</td>
          </tr>`;
        }).join("")}
      </tbody>
    </table>
